...
sub clear {
    ...
    $iSave_mute_picks->{_binheader_type}= '';
...
sub binheader_type {
   ...
   $iSave_mute_picks->{_binheader_type} 		= $binheader_type if defined ($binheader_type);
}
...
sub calc {
  ...
  my $suffix = '_'.$iSave_mute_picks->{_binheader_type}.
		$iSave_mute_picks->{_gather_num};

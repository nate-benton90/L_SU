...
=cut
 ...
 my $sumute_1_binheader_type    = $cfg->param("sumute_1_binheader_type");  
...
=cut
 ...
 my $suinterp_1_number_of_traces_to_smooth    = $cfg->param("suinterp_1_number_of_traces_to_smooth");
 my $suinterp_1_number_of_samples_to_smooth   = $cfg->param("suinterp_1_number_of_samples_to_smooth");
 my $suinterp_1_min_freq_Hz 		      = $cfg->param("suinterp_1_min_freq_Hz");
 my $suinterp_1_number_new_traces2interpolate = $cfg->param("suinterp_1_number_new_traces2interpolate");
 my $suinterp_1_current_trace_separation      = $cfg->param("suinterp_1_current_trace_separation");
...
=cut
 ...
 our $CFG = {
    ...
    TOP_MIDDLE_WIGGLE_PLOT => {
        suxwigb => {
          absclip        => $suxwigb_2_absclip
         }      
    },    
    TOP_RIGHT_WIGGLE_PLOT => {
        suxwigb => {
    ...
    TOP_RIGHT_IMAGE => {
        suximage => {
          absclip     	 => $suximage_1_absclip
         }      
    },
    BOTTOM_RIGHT_WIGGLE_PLOT => {
        suxwigb => {
          absclip     	 => $suxwigb_3_absclip
         }      
    },
    ...
    sumute => {
		...
		binheader_type	=>  $sumute_1_binheader_type
         }
    },
    suinterp => {
        1	=> { 
		number_of_traces_to_smooth	=>  $suinterp_1_number_of_traces_to_smooth,
		number_of_samples_to_smooth	=>  $suinterp_1_number_of_samples_to_smooth, 
		min_freq_Hz			=>  $suinterp_1_min_freq_Hz, 
		number_new_traces2interpolate   =>  $suinterp_1_number_new_traces2interpolate, 

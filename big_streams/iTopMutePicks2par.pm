...
sub type {
   my($variable,$type)  = @_;
   $iTopMutePicks2par->{_type}   = $iTopMutePicks2par if defined($iTopMutePicks2par);
}
...
=cut
  ...
  $mkparfile_out = $itemp_top_mute_picks_sorted_par_.$iTopMutePicks2par->{_file_in};
...
#   print("Regular xt data\n\n");
 ...
 @items   = ($mkparfile[1],$in,$iTopMutePicks2par->{TX_inbound},$out,$iTopMutePicks2par->{TX_outbound});

...
sub type {
   my($variable,$type)  = @_;
   $iBottomMutePicks2par->{_type}   = $iBottomMutePicks2par if defined($iBottomMutePicks2par);
}
...
=cut
  ...
  $mkparfile_out = $itemp_bot_mute_picks_sorted_par_.$iBottomMutePicks2par->{_file_in};
...
#   print("Regular xt data\n\n");
 ...
 @items   = ($mkparfile[1],$in,$iBottomMutePicks2par->{TX_inbound},$out,$iBottomMutePicks2par->{TX_outbound});

...
=cut
 ...
 sub labelfont {
	...
	if ( $labelfont ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' labelfont='.$xwigb->{_labelfont};
		$xwigb->{_Step}		= $xwigb->{_Step}.' labelfont='.$xwigb->{_labelfont};
...
=cut
 ...
 sub titlefont {
	...
	if ( $titlefont ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' titlefont='.$xwigb->{_titlefont};
		$xwigb->{_Step}		= $xwigb->{_Step}.' titlefont='.$xwigb->{_titlefont};
...
=cut
 ...
 sub windowtitle {
	...
	if ( $windowtitle ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' windowtitle='.$xwigb->{_windowtitle};
		$xwigb->{_Step}		= $xwigb->{_Step}.' windowtitle='.$xwigb->{_windowtitle};
...
=cut
 ...
 sub labelcolor {
	...
	if ( $labelcolor ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' labelcolor='.$xwigb->{_labelcolor};
		$xwigb->{_Step}		= $xwigb->{_Step}.' labelcolor='.$xwigb->{_labelcolor};
...
=cut
 ...
 sub titlecolor {
	...
	if ( $titlecolor ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' titlecolor='.$xwigb->{_titlecolor};
		$xwigb->{_Step}		= $xwigb->{_Step}.' titlecolor='.$xwigb->{_titlecolor};
...
=cut
 ...
 sub gridcolor {
	...
	if ( $gridcolor ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' gridcolor='.$xwigb->{_gridcolor};
		$xwigb->{_Step}		= $xwigb->{_Step}.' gridcolor='.$xwigb->{_gridcolor};
...
=cut
 ...
 sub plotfile {
	...
	if ( $plotfile ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' plotfile='.$xwigb->{_plotfile};
		$xwigb->{_Step}		= $xwigb->{_Step}.' plotfile='.$xwigb->{_plotfile};
...
=cut
 ...
 sub curvecolor {
	...
	if ( $curvecolor ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' curvecolor='.$xwigb->{_curvecolor};
		$xwigb->{_Step}		= $xwigb->{_Step}.' curvecolor='.$xwigb->{_curvecolor};
...
=cut
 ...
 sub curvefile {
	...
	if ( $curvefile ) {
		...
		$xwigb->{_note}		= $xwigb->{_note}.' curvefile='.$xwigb->{_curvefile};
		$xwigb->{_Step}		= $xwigb->{_Step}.' curvefile='.$xwigb->{_curvefile};

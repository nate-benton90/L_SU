...
=cut
 	...
 	$package_name[0]		= 'sufilter'; 
  	$package_name[0]		= 'sufft';		
   	...
   	$package_name[0]		= 'surange';
   	$package_name[0]		= 'sustolt';
 	$package_name[0] 		= 'a2b';
  	$package_name[0] 		= 'sustrip';
   	$package_name[0] 		= 'ximage';
   	$package_name[0] 		= 'suximage';
  	$package_name[0] 		= 'b2a';  	   	  				
	...
	$file_in[0]				= 'surange.su.main.headers';	
	$file_in[0]				= 'sustolt.su.main.migration_inversion';
 	$file_in[0] 			= 'a2b.par.main';
 	$file_in[0] 			= 'sustrip.su.main.headers';
 	$file_in[0]				= 'ximage.xplot.main';
  	$file_in[0]				= 'suximage.su.graphics.xplot';
  	$file_in[0] 			= 'b2a.par.main';

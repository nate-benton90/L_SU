...
=head2  sub _sub_get_binding_index_aref_section

=cut
 
 sub _sub_get_binding_index_aref_section {
	my $self = @_;
...
sub get_subroutine_section {
    ...
    my @get_binding 		= @{_sub_get_binding_index_aref_section()};
#    my @file_dialog 		= @{_sub_file_dialog_type_aref()}; 
#    my @get_max_index		= @{_sub_get_max_index()}; 
#    my @get_file_dialog 	= @{_sub_get_file_dialog_type_aref()};
#    my @flow_type			= @{_sub_flow_type_aref()};
...
#    my @variables			= @{_sub_variables()}; 
    ...
    $head[0]    = $binding[0];
    $head[1]    = $get_binding[0];
#    $head[2]    = $file_dialog[0];
#    $head[3]    = $get_max_index[0];
#    $head[4]    = $get_file_dialog[0];
#    $head[5]    = $flow_type[0];    
#    $head[6]    = $get_flow_type[0];	
#    $head[7]    = $get_binding_length[0];
#    $head[8]    = $variables[0];        

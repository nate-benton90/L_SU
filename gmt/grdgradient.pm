...
=cut
 ...
 sub V {
   ...
   if ( $V eq $on ) {
     $grdgradient->{_V}	= '';
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -V'.$grdgradient->{_V};
     $grdgradient->{_note}	= $grdgradient->{_note}.' -V'.$grdgradient->{_V};
   }
 }
...
=cut
 ...
 sub verbose {
   ...
   if ( $verbose eq $on ) {
     ...
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -V'.$grdgradient->{_verbose};
     $grdgradient->{_note}	= $grdgradient->{_note}.' -V'.$grdgradient->{_verbose};
   }
 }
...
=cut
 ...
 sub A {
   ...
   if ( $A ) {
     $grdgradient->{_A}		= $A;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -A'.$grdgradient->{_A};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -A'.$grdgradient->{_A};
   }
 }
...
=cut
 ...
 sub D {
   ...
   if ( $D ) {
     $grdgradient->{_D}		= $D;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -D'.$grdgradient->{_D};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -D'.$grdgradient->{_D};
   }
 }
...
=cut
 ...
 sub E {
   ...
   if ( $E ) {
     $grdgradient->{_E}		= $E;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -E'.$grdgradient->{_E};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -E'.$grdgradient->{_E};
   }
 }
...
=cut
 ...
 sub G {
   ...
   if ( $G ) {
     $grdgradient->{_G}		= $G;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -G'.$grdgradient->{_G};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -G'.$grdgradient->{_G};
   }
 }
...
=cut
 ...
 sub L {
   ...
   if ( $L ) {
     $grdgradient->{_L}		= $L;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -L'.$grdgradient->{_L};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -L'.$grdgradient->{_L};
   }
 }
...
=cut
 ...
 sub M {
   ...
   if ( $M ) {
     $grdgradient->{_M}		= $M;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -M'.$grdgradient->{_M};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -M'.$grdgradient->{_M};
   }
 }
...
=cut
 ...
 sub N {
   ...
   if ( $N ) {
     $grdgradient->{_N}		= $N;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -N'.$grdgradient->{_N};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -N'.$grdgradient->{_N};
   }
 }
...
=cut
 ...
 sub Nt {
   ...
   if ( $Nt ) {
     $grdgradient->{_Nt}		= $Nt;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -Nt'.$grdgradient->{_Nt};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -Nt'.$grdgradient->{_Nt};
   }
 }
...
=cut
 ...
 sub Ne {
   ...
   if ( $Ne ) {
     $grdgradient->{_Ne}		= $Ne;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -Ne'.$grdgradient->{_Ne};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -Ne'.$grdgradient->{_Ne};
   }
 }
...
=cut
 ...
 sub S {
   ...
   if ( $S ) {
     $grdgradient->{_S}		= $S;
     $grdgradient->{_note}	= $grdgradient->{_note}.' -S'.$grdgradient->{_S};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -S'.$grdgradient->{_S};
   }
 }
...
=cut
 ...
 sub infile {
   ...
   if ( $infile ) {
     ...
     $grdgradient->{_note}	= $grdgradient->{_note}.' '.$grdgradient->{_infile};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' '.$grdgradient->{_infile};
   }
 }
...
=cut
 ...
 sub outfile {
   ...
   if ( $outfile ) {
     ...
     $grdgradient->{_note}	= $grdgradient->{_note}.' -G'.$grdgradient->{_outfile};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -G'.$grdgradient->{_outfile};
   }
 }
...
=cut
 sub limits {
   ...
   if ( $limits ) {
     ...
     $grdgradient->{_note}	= $grdgradient->{_note}.' -R'.$grdgradient->{_limits};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -R'.$grdgradient->{_limits};
   }
 }
...
=cut
 sub no_head {
   ...
   if ( $no_head ) {
     ...
     $grdgradient->{_note}	= $grdgradient->{_note}.' -K'.$grdgradient->{_no_head};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -K'.$grdgradient->{_no_head};
   }
 }
...
=cut
 sub no_tail {
   ...
   if ( $no_tail ) {
     ...
     $grdgradient->{_note}	= $grdgradient->{_note}.' -O'.$grdgradient->{_no_tail};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -O'.$grdgradient->{_no_tail};
   }
 }
...
=cut
 sub projection {
   ...
   if ( $projection ) {
     ...
     $grdgradient->{_note}	= $grdgradient->{_note}.' -J'.$grdgradient->{_projection};
     $grdgradient->{_Step}	= $grdgradient->{_Step}.' -J'.$grdgradient->{_projection};
   }
 }

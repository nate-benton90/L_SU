...
=cut
 ...
 sub verbose {
   ...
   if ( $verbose eq $on ) {
     $psbasemap->{_verbose}	= '';
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -V'.$psbasemap->{_verbose};
     $psbasemap->{_note}	= $psbasemap->{_note}.' -V'.$psbasemap->{_verbose};
   }
 }
...
=cut
 ...
 sub ticks {
   ...
   if ( $ticks ) {
     ...
     $psbasemap->{_note}	= $psbasemap->{_note}.' -B'.$psbasemap->{_ticks};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -B'.$psbasemap->{_ticks};
   }
 }
...
=cut
 ...
 sub Bs {
   ...
   if ( $Bs ) {
     $psbasemap->{_Bs}		= $Bs;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -Bs'.$psbasemap->{_Bs};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -Bs'.$psbasemap->{_Bs};
   }
 }
...
=cut
 ...
 sub Rg {
   ...
   if ( $Rg ) {
     $psbasemap->{_Rg}		= $Rg;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -Rg'.$psbasemap->{_Rg};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -Rg'.$psbasemap->{_Rg};
   }
 }
...
=cut
 ...
 sub Jp {
   ...
   if ( $Jp ) {
     $psbasemap->{_Jp}		= $Jp;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -Jp'.$psbasemap->{_Jp};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -Jp'.$psbasemap->{_Jp};
   }
 }
...
=cut
 ...
 sub JX {
   ...
   if ( $JX ) {
     $psbasemap->{_JX}		= $JX;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -JX'.$psbasemap->{_JX};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -JX'.$psbasemap->{_JX};
   }
 }
...
=cut
 ...
 sub Jz {
   ...
   if ( $Jz ) {
     $psbasemap->{_Jz}		= $Jz;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -Jz'.$psbasemap->{_Jz};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -Jz'.$psbasemap->{_Jz};
   }
 }
...
=cut
 ...
 sub Lx {
   ...
   if ( $Lx ) {
     $psbasemap->{_Lx}		= $Lx;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -Lx'.$psbasemap->{_Lx};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -Lx'.$psbasemap->{_Lx};
   }
 }
...
=cut
 ...
 sub Lf {
   ...
   if ( $Lf ) {
     $psbasemap->{_Lf}		= $Lf;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -Lf'.$psbasemap->{_Lf};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -Lf'.$psbasemap->{_Lf};
   }
 }
...
=cut
 ...
 sub portrait {
   ...
   if ( $portrait eq $on ) {
     $psbasemap->{_portrait}		= '';
     $psbasemap->{_note}	= $psbasemap->{_note}.' -P'.$psbasemap->{_portrait};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -P'.$psbasemap->{_portrait};
   }
 }
...
=cut
 ...
 sub Tx {
   ...
   if ( $Tx ) {
     $psbasemap->{_Tx}		= $Tx;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -Tx'.$psbasemap->{_Tx};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -Tx'.$psbasemap->{_Tx};
   }
 }
...
=cut
 ...
 sub Uc {
   ...
   if ( $Uc ) {
     $psbasemap->{_Uc}		= $Uc;
     $psbasemap->{_note}	= $psbasemap->{_note}.' -Uc'.$psbasemap->{_Uc};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -Uc'.$psbasemap->{_Uc};
   }
 }
...
=cut
 sub limits {
   ...
   if ( $limits ) {
     ...
     $psbasemap->{_note}	= $psbasemap->{_note}.' -R'.$psbasemap->{_limits};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -R'.$psbasemap->{_limits};
   }
 }
...
=cut
 sub no_head {
   ...
   if ( $no_head ) {
     ...
     $psbasemap->{_note}	= $psbasemap->{_note}.' -K'.$psbasemap->{_no_head};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -K'.$psbasemap->{_no_head};
   }
 }
...
=cut
 ...
 sub no_tail {
   ...
   if ( $no_tail ) {
     ...
     $psbasemap->{_note}	= $psbasemap->{_note}.' -O'.$psbasemap->{_no_tail};
     $psbasemap->{_Step}	= $psbasemap->{_Step}.' -O'.$psbasemap->{_no_tail};
   }
 }
...
=cut
 ...
 sub projection {
   ...
   if ( $projection) {
     ...
     $psbasemap->{_note}		= $psbasemap->{_note}.' -J'.$psbasemap->{_projection};
     $psbasemap->{_Step}		= $psbasemap->{_Step}.' -J'.$psbasemap->{_projection};
   }
 }

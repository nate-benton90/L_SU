...
=cut
 ...
 sub convergence_limit {
   ...
   if ( $convergence_limit ) {
     ...
     $surface->{_note}	= $surface->{_note}.' -C'.$surface->{_convergence_limit};
     $surface->{_Step}	= $surface->{_Step}.' -C'.$surface->{_convergence_limit};
   }
 }
...
=cut
 ...
 sub grid_spacing {
   ...
   if ( $grid_spacing ) {
     ...
     $surface->{_note}	= $surface->{_note}.' -I'.$surface->{_grid_spacing};
     $surface->{_Step}	= $surface->{_Step}.' -I'.$surface->{_grid_spacing};
   }
 }

...
=cut
 ...
 sub color_table {
   ...
   if ( $color_table ) {
     ...
     $grdimage->{_note}	= $grdimage->{_note}.' -C'.$grdimage->{_color_table};
     $grdimage->{_Step}	= $grdimage->{_Step}.' -C'.$grdimage->{_color_table};
   }
 }
...
=cut
 ...
 sub projection {
   ...
   if ( $projection ) {
     ...
     $grdimage->{_note}	= $grdimage->{_note}.' -J'.$grdimage->{_projection};
     $grdimage->{_Step}	= $grdimage->{_Step}.' -J'.$grdimage->{_projection};
   }
 }
...
=cut
 ...
 sub portrait {
   ...
   if ( $portrait eq $on) {
     $grdimage->{_portrait}		= '';
     $grdimage->{_note}	= $grdimage->{_note}.' -P'.$grdimage->{_portrait};
     $grdimage->{_Step}	= $grdimage->{_Step}.' -P'.$grdimage->{_portrait};
   }
 }
...
=cut
 ...
 sub limits {
   ...
   if ( $limits ) {
     ...
     $grdimage->{_note}	= $grdimage->{_note}.' -R'.$grdimage->{_limits};
     $grdimage->{_Step}	= $grdimage->{_Step}.' -R'.$grdimage->{_limits};
   }
 }
...
=cut
 ...
 sub verbose {
   ...
   if ( $verbose eq $on) {
     $grdimage->{_verbose}		= '';
     $grdimage->{_note}	= $grdimage->{_note}.' -V'.$grdimage->{_verbose};
     $grdimage->{_Step}	= $grdimage->{_Step}.' -V'.$grdimage->{_verbose};
   }
 }

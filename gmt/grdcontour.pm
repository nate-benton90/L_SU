...
=cut
 ...
 sub infile {
   ...
   if ( $infile ) {
     ...
     $grdcontour->{_note}	= $grdcontour->{_note}.' '.$grdcontour->{_infile};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' '.$grdcontour->{_infile};
   }
 }
...
=cut
 ...
 sub C {
   ...
   if ( $C ) {
     $grdcontour->{_C}		= $C;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -C'.$grdcontour->{_C};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -C'.$grdcontour->{_C};
   }
 }
...
=cut
 ...
 sub T {
   ...
   if ( $T ) {
     $grdcontour->{_T}		= $T;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -T'.$grdcontour->{_T};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -T'.$grdcontour->{_T};
   }
 }
...
=cut
 ...
 sub A {
   ...
   if ( $A ) {
     $grdcontour->{_A}		= $A;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -A'.$grdcontour->{_A};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -A'.$grdcontour->{_A};
   }
 }
...
=cut
 ...
 sub projection {
   ...
   if ( $projection ) {
     ...
     $grdcontour->{_note}	= $grdcontour->{_note}.' -J'.$grdcontour->{_projection};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -J'.$grdcontour->{_projection};
   }
 }
...
=cut
 ...
 sub J {
   ...
   if ( $J ) {
     $grdcontour->{_J}		= $J;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -J'.$grdcontour->{_J};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -J'.$grdcontour->{_J};
   }
 }
...
=cut
 ...
 sub Rg {
   ...
   if ( $Rg ) {
     $grdcontour->{_Rg}		= $Rg;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -Rg'.$grdcontour->{_Rg};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -Rg'.$grdcontour->{_Rg};
   }
 }
...
=cut
 ...
 sub B {
   ...
   if ( $B ) {
     $grdcontour->{_B}		= $B;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -B'.$grdcontour->{_B};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -B'.$grdcontour->{_B};
   }
 }
...
=cut
 ...
 sub D {
   ...
   if ( $D ) {
     $grdcontour->{_D}		= $D;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -D'.$grdcontour->{_D};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -D'.$grdcontour->{_D};
   }
 }
...
=cut
 ...
 sub E {
   ...
   if ( $E ) {
     $grdcontour->{_E}		= $E;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -E'.$grdcontour->{_E};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -E'.$grdcontour->{_E};
   }
 }
...
=cut
 ...
 sub F {
   ...
   if ( $F ) {
     $grdcontour->{_F}		= $F;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -F'.$grdcontour->{_F};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -F'.$grdcontour->{_F};
   }
 }
...
=cut
 ...
 sub G {
   ...
   if ( $G ) {
     $grdcontour->{_G}		= $G;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -G'.$grdcontour->{_G};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -G'.$grdcontour->{_G};
   }
 }
...
=cut
 ...
 sub K {
   ...
   if ( $K ) {
     $grdcontour->{_K}		= $K;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -K'.$grdcontour->{_K};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -K'.$grdcontour->{_K};
   }
 }
...
=cut
 ...
 sub L {
   ...
   if ( $L ) {
     $grdcontour->{_L}		= $L;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -L'.$grdcontour->{_L};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -L'.$grdcontour->{_L};
   }
 }
...
=cut
 ...
 sub O {
   ...
   if ( $O ) {
     $grdcontour->{_O}		= $O;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -O'.$grdcontour->{_O};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -O'.$grdcontour->{_O};
   }
 }
...
=cut
 ...
 sub P {
   ...
   if ( $P ) {
     $grdcontour->{_P}		= $P;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -P'.$grdcontour->{_P};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -P'.$grdcontour->{_P};
   }
 }
...
=cut
 ...
 sub Q {
   ...
   if ( $Q ) {
     $grdcontour->{_Q}		= $Q;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -Q'.$grdcontour->{_Q};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -Q'.$grdcontour->{_Q};
   }
 }
...
=cut
 ...
 sub limits {
   ...
   if ( $limits ) {
     ...
     $grdcontour->{_note}	= $grdcontour->{_note}.' -R'.$grdcontour->{_limits};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -R'.$grdcontour->{_limits};
   }
 }
...
=cut
 ...
 sub R {
   ...
   if ( $R ) {
     $grdcontour->{_R}		= $R;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -R'.$grdcontour->{_R};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -R'.$grdcontour->{_R};
   }
 }
...
=cut
 ...
 sub S {
   ...
   if ( $S ) {
     $grdcontour->{_S}		= $S;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -S'.$grdcontour->{_S};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -S'.$grdcontour->{_S};
   }
 }
...
=cut
 ...
 sub U {
   ...
   if ( $U ) {
     $grdcontour->{_U}		= $U;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -U'.$grdcontour->{_U};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -U'.$grdcontour->{_U};
   }
 }
...
=cut
 ...
 sub Uc {
   ...
   if ( $Uc ) {
     $grdcontour->{_Uc}		= $Uc;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -Uc'.$grdcontour->{_Uc};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -Uc'.$grdcontour->{_Uc};
   }
 }
...
=cut
 ...
 sub V {
   ...
   if ( $V ) {
     $grdcontour->{_V}		= $V;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -V'.$grdcontour->{_V};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -V'.$grdcontour->{_V};
   }
 }
...
=cut
 ...
 sub W {
   ...
   if ( $W ) {
     $grdcontour->{_W}		= $W;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -W'.$grdcontour->{_W};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -W'.$grdcontour->{_W};
   }
 }
...
=cut
 ...
 sub X {
   ...
   if ( $X ) {
     $grdcontour->{_X}		= $X;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -X'.$grdcontour->{_X};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -X'.$grdcontour->{_X};
   }
 }
...
=cut
 ...
 sub Z {
   ...
   if ( $Z ) {
     $grdcontour->{_Z}		= $Z;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -Z'.$grdcontour->{_Z};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -Z'.$grdcontour->{_Z};
   }
 }
...
=cut
 ...
 sub bo {
   ...
   if ( $bo ) {
     $grdcontour->{_bo}		= $bo;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -bo'.$grdcontour->{_bo};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -bo'.$grdcontour->{_bo};
   }
 }
...
=cut
 ...
 sub m {
   ...
   if ( $m ) {
     $grdcontour->{_m}		= $m;
     $grdcontour->{_note}	= $grdcontour->{_note}.' -m'.$grdcontour->{_m};
     $grdcontour->{_Step}	= $grdcontour->{_Step}.' -m'.$grdcontour->{_m};
   }
 }

...
=cut
 ...
 sub grid_spacing {
   ...
   if ( $grid_spacing ) {
     ...
     $blockmean->{_note}	= $blockmean->{_note}.' -I'.$blockmean->{_grid_spacing};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -I'.$blockmean->{_grid_spacing};
   }
 }
...
=cut
 ...
 sub inbound {
   ...
   if ( $inbound ) {
     ...
     $blockmean->{_note}	= $blockmean->{_note}.' '.$blockmean->{_inbound};
     $blockmean->{_Step}	= $blockmean->{_Step}.' '.$blockmean->{_inbound};
...
=cut
 ...
 sub limits {
   ...
   if ( $limits ) {
     ...
     $blockmean->{_note}	= $blockmean->{_note}.' -R'.$blockmean->{_limits};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -R'.$blockmean->{_limits};
   }
 }
...
=cut
 ...
 sub Rd {
   ...
   if ( $Rd ) {
     $blockmean->{_Rd}		= $Rd;
     $blockmean->{_note}	= $blockmean->{_note}.' -Rd'.$blockmean->{_Rd};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -Rd'.$blockmean->{_Rd};
   }
 }
...
=cut
 ...
 sub Rg {
   ...
   if ( $Rg ) {
     $blockmean->{_Rg}		= $Rg;
     $blockmean->{_note}	= $blockmean->{_note}.' -Rg'.$blockmean->{_Rg};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -Rg'.$blockmean->{_Rg};
   }
 }
...
=cut
 ...
 sub Sz {
   ...
   if ( $Sz ) {
     $blockmean->{_Sz}		= $Sz;
     $blockmean->{_note}	= $blockmean->{_note}.' -Sz'.$blockmean->{_Sz};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -Sz'.$blockmean->{_Sz};
   }
 }
...
=cut
 ...
 sub Sw {
   ...
   if ( $Sw ) {
     $blockmean->{_Sw}		= $Sw;
     $blockmean->{_note}	= $blockmean->{_note}.' -Sw'.$blockmean->{_Sw};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -Sw'.$blockmean->{_Sw};
   }
 }
...
=cut
 ...
 sub verbose {
   ...
   if ( $verbose eq $on ) {
     $blockmean->{_verbose}		= '';
     $blockmean->{_note}	= $blockmean->{_note}.' -V'.$blockmean->{_verbose};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -V'.$blockmean->{_verbose};
   }
 }
...
=cut
 ...
 sub Wi {
   ...
   if ( $Wi ) {
     $blockmean->{_Wi}		= $Wi;
     $blockmean->{_note}	= $blockmean->{_note}.' -Wi'.$blockmean->{_Wi};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -Wi'.$blockmean->{_Wi};
   }
 }
...
=cut
 ...
 sub Wo {
   ...
   if ( $Wo ) {
     $blockmean->{_Wo}		= $Wo;
     $blockmean->{_note}	= $blockmean->{_note}.' -Wo'.$blockmean->{_Wo};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -Wo'.$blockmean->{_Wo};
   }
 }
...
=cut
 ...
 sub bi {
   ...
   if ( $bi ) {
     $blockmean->{_bi}		= $bi;
     $blockmean->{_note}	= $blockmean->{_note}.' -bi'.$blockmean->{_bi};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -bi'.$blockmean->{_bi};
   }
 }
...
=cut
 ...
 sub bo {
   ...
   if ( $bo ) {
     $blockmean->{_bo}		= $bo;
     $blockmean->{_note}	= $blockmean->{_note}.' -bo'.$blockmean->{_bo};
     $blockmean->{_Step}	= $blockmean->{_Step}.' -bo'.$blockmean->{_bo};
   }
 }

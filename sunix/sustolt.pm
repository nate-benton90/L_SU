...
=cut
 ...
 sub cdpmax {
	...
	if ( $cdpmax ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' cdpmax='.$sustolt->{_cdpmax};
		$sustolt->{_Step}		= $sustolt->{_Step}.' cdpmax='.$sustolt->{_cdpmax};
...
=cut
 ...
 sub cdpmin {
	...
	if ( $cdpmin ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' cdpmin='.$sustolt->{_cdpmin};
		$sustolt->{_Step}		= $sustolt->{_Step}.' cdpmin='.$sustolt->{_cdpmin};
...
=cut
 ...
 sub dxcdp {
	...
	if ( $dxcdp ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' dxcdp='.$sustolt->{_dxcdp};
		$sustolt->{_Step}		= $sustolt->{_Step}.' dxcdp='.$sustolt->{_dxcdp};
...
=cut
 ...
 sub lbtaper {
	...
	if ( $lbtaper ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' lbtaper='.$sustolt->{_lbtaper};
		$sustolt->{_Step}		= $sustolt->{_Step}.' lbtaper='.$sustolt->{_lbtaper};
...
=cut
 ...
 sub lstaper {
	...
	if ( $lstaper ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' lstaper='.$sustolt->{_lstaper};
		$sustolt->{_Step}		= $sustolt->{_Step}.' lstaper='.$sustolt->{_lstaper};
...
=cut
 ...
 sub noffmix {
	...
	if ( $noffmix ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' noffmix='.$sustolt->{_noffmix};
		$sustolt->{_Step}		= $sustolt->{_Step}.' noffmix='.$sustolt->{_noffmix};
...
=cut
 ...
 sub tmpdir {
	...
	if ( $tmpdir ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' tmpdir='.$sustolt->{_tmpdir};
		$sustolt->{_Step}		= $sustolt->{_Step}.' tmpdir='.$sustolt->{_tmpdir};
...
=cut
 ...
 sub verbose {
	...
	if ( $verbose ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' verbose='.$sustolt->{_verbose};
		$sustolt->{_Step}		= $sustolt->{_Step}.' verbose='.$sustolt->{_verbose};
...
=cut
 ...
 sub vscale {
	...
	if ( $vscale ) {
		...
		$sustolt->{_note}		= $sustolt->{_note}.' vscale='.$sustolt->{_vscale};
		$sustolt->{_Step}		= $sustolt->{_Step}.' vscale='.$sustolt->{_vscale};

...
sub absclip {
    my ($variable, $clip) 	= @_;
    $ximage->{_clip}          = $clip if defined($clip);
    $ximage->{_Step}          = $ximage->{_Step}.' clip='.$ximage->{_clip}; 
    $ximage->{_note}       	= $ximage->{_note};
}
...
=cut
 ...
 sub balance {
	...
	if ( $balance ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' balance='.$ximage->{_balance};
		$ximage->{_Step}		= $ximage->{_Step}.' balance='.$ximage->{_balance};
...
=cut
 ...
 sub blockinterp {
	...
	if ( $blockinterp ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' blockinterp='.$ximage->{_blockinterp};
		$ximage->{_Step}		= $ximage->{_Step}.' blockinterp='.$ximage->{_blockinterp};
...
=cut
 ...
 sub curvecolor {
	...
	if ( $curvecolor ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' curvecolor='.$ximage->{_curvecolor};
		$ximage->{_Step}		= $ximage->{_Step}.' curvecolor='.$ximage->{_curvecolor};
...
=cut
 ...
 sub curvefile {
	...
	if ( $curvefile ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' curvefile='.$ximage->{_curvefile};
		$ximage->{_Step}		= $ximage->{_Step}.' curvefile='.$ximage->{_curvefile};
...
=cut
 ...
 sub gridcolor {
	...
	if ( $gridcolor ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' gridcolor='.$ximage->{_gridcolor};
		$ximage->{_Step}		= $ximage->{_Step}.' gridcolor='.$ximage->{_gridcolor};
...
=cut
 ...
 sub labelcolor {
	...
	if ( $labelcolor ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' labelcolor='.$ximage->{_labelcolor};
		$ximage->{_Step}		= $ximage->{_Step}.' labelcolor='.$ximage->{_labelcolor};
...
=cut
 ...
 sub labelfont {
	...
	if ( $labelfont ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' labelfont='.$ximage->{_labelfont};
		$ximage->{_Step}		= $ximage->{_Step}.' labelfont='.$ximage->{_labelfont};
...
=cut
 ...
 sub legendfont {
	...
	if ( $legendfont ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' legendfont='.$ximage->{_legendfont};
		$ximage->{_Step}		= $ximage->{_Step}.' legendfont='.$ximage->{_legendfont};
...
=cut
 ...
 sub lheight {
	...
	if ( $lheight ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' lheight='.$ximage->{_lheight};
		$ximage->{_Step}		= $ximage->{_Step}.' lheight='.$ximage->{_lheight};
...
=cut
 ...
 sub plotfile {
	...
	if ( $plotfile ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' plotfile='.$ximage->{_plotfile};
		$ximage->{_Step}		= $ximage->{_Step}.' plotfile='.$ximage->{_plotfile};
...
=cut
 ...
 sub titlecolor {
	...
	if ( $titlecolor ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' titlecolor='.$ximage->{_titlecolor};
		$ximage->{_Step}		= $ximage->{_Step}.' titlecolor='.$ximage->{_titlecolor};
...
=cut
 ...
 sub titlefont {
	...
	if ( $titlefont ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' titlefont='.$ximage->{_titlefont};
		$ximage->{_Step}		= $ximage->{_Step}.' titlefont='.$ximage->{_titlefont};
...
=cut
 ...
 sub verbose {
	...
	if ( $verbose ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' verbose='.$ximage->{_verbose};
		$ximage->{_Step}		= $ximage->{_Step}.' verbose='.$ximage->{_verbose};
...
=cut
 ...
 sub windowtitle {
	...
	if ( $windowtitle ) {
		...
		$ximage->{_note}		= $ximage->{_note}.' windowtitle='.$ximage->{_windowtitle};
		$ximage->{_Step}		= $ximage->{_Step}.' windowtitle='.$ximage->{_windowtitle};

...
=cut
 ...
 sub amps {
	...
	if ( $amps ) {
		...
		$sufilter->{_amps}		= $amps;
		$sufilter->{_note}		= $sufilter->{_note}.' amps='.$sufilter->{_amps};
		$sufilter->{_Step}		= $sufilter->{_Step}.' amps='.$sufilter->{_amps};
...
=cut
 ...
 sub verbose {
	...
	if ( $verbose ) {
		...
		$sufilter->{_note}		= $sufilter->{_note}.' verbose='.$sufilter->{_verbose};
		$sufilter->{_Step}		= $sufilter->{_Step}.' verbose='.$sufilter->{_verbose};

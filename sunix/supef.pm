...
=cut
 ...
 sub showwiener {
   ...
   if ( $showwiener ) {
     ...
     $supef->{_note}	= $supef->{_note}.'showwiener'.$supef->{_showwiener};
     $supef->{_Step}	= $supef->{_Step}.'showwiener'.$supef->{_showwiener};
   }
 }
...
=cut
 ...
 sub MAXLAG_PEF {
   ...
   if ( $MAXLAG_PEF ) {
     ...
     $supef->{_note}	= $supef->{_note}.'MAXLAG_PEF'.$supef->{_MAXLAG_PEF};
     $supef->{_Step}	= $supef->{_Step}.'MAXLAG_PEF'.$supef->{_MAXLAG_PEF};
   }
 }
...
=cut
 ...
 sub showweiner {
   ...
   if ( $showweiner ) {
     ...
     $supef->{_note}	= $supef->{_note}.'showweiner'.$supef->{_showweiner};
     $supef->{_Step}	= $supef->{_Step}.'showweiner'.$supef->{_showweiner};
   }
 }

...
sub v0{
   ...
   if($v0) {
    $sustatic->{_v0}    	= $v0;
    $sustatic->{_Step}       	= $sustatic->{_Step}.' v0='.$sustatic->{_source_statics_output_file} ;
    $sustatic->{_note}       	= $sustatic->{_note}.' v0='.$sustatic->{_source_statics_output_file} ;
   }
}
...
sub v1{
   ...
   if($v1) {
    $sustatic->{_v1}    	= $v1;
    $sustatic->{_Step}       	= $sustatic->{_Step}.' v1='.$sustatic->{_source_statics_output_file} ;
    $sustatic->{_note}       	= $sustatic->{_note}.' v1='.$sustatic->{_source_statics_output_file} ;
   }
}

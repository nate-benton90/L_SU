...
=head3 SEISMIC UNIX NOTES
 ...
 also applies to the same package
...
=cut
 ...
 sub infile {
	...
	if ( $infile ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' infile='.$suximage->{_infile};
		$suximage->{_Step}		= $suximage->{_Step}.' infile='.$suximage->{_infile};
...
=cut
 ...
 sub balance {
	...
	if ( $balance ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' balance='.$suximage->{_balance};
		$suximage->{_Step}		= $suximage->{_Step}.' balance='.$suximage->{_balance};
...
=cut
 ...
 sub bclip {
	...
	if ( $bclip ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' bclip='.$suximage->{_bclip};
		$suximage->{_Step}		= $suximage->{_Step}.' bclip='.$suximage->{_bclip};
...
=cut
 ...
 sub blank {
	...
	if ( $blank ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' blank='.$suximage->{_blank};
		$suximage->{_Step}		= $suximage->{_Step}.' blank='.$suximage->{_blank};
...
=cut
 ...
 sub blockinterp {
	...
	if ( $blockinterp ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' blockinterp='.$suximage->{_blockinterp};
		$suximage->{_Step}		= $suximage->{_Step}.' blockinterp='.$suximage->{_blockinterp};
...
=cut
 ...
 sub box_X0{
	...
	if ( $xbox ) {
		...
		$suximage->{_xbox}			= $xbox;
		$suximage->{_note}		= $suximage->{_note}.' xbox='.$suximage->{_xbox};
...
=cut
 ...
 sub box_Y0{
	...
	if ( $ybox ) {
		...
		$suximage->{_ybox}		= $ybox;
		$suximage->{_note}		= $suximage->{_note}.' ybox='.$suximage->{_ybox};
...
=cut
 ...
 sub box_height{
	...
	if ( $hbox ) {
		...
		$suximage->{_hbox}		= $hbox;
		$suximage->{_note}		= $suximage->{_note}.' hbox='.$suximage->{_hbox};
...
=cut
 ...
 sub box_width {
	...
	if ( $wbox ) {
		...
		$suximage->{_wbox}		= $wbox;
		$suximage->{_note}		= $suximage->{_note}.' wbox='.$suximage->{_wbox};
...
=cut
 ...
 sub bperc {
	...
	if ( $bperc ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' bperc='.$suximage->{_bperc};
		$suximage->{_Step}		= $suximage->{_Step}.' bperc='.$suximage->{_bperc};
...
=cut
 ...
 sub clip {
	...
	if ( $clip ) {
		...
		$suximage->{_clip}		= $clip;
		$suximage->{_note}		= $suximage->{_note}.' clip='.$suximage->{_clip};
		$suximage->{_Step}		= $suximage->{_Step}.' clip='.$suximage->{_clip};
...
=cut
 ...
 sub cmap {
	...
	if ( $cmap ) {
		...
		$suximage->{_cmap}		= $cmap;
		$suximage->{_note}		= $suximage->{_note}.' cmap='.$suximage->{_cmap};
...
=cut
 ...
 sub curve {
	...
	if ( $curve ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' curve='.$suximage->{_curve};
		$suximage->{_Step}		= $suximage->{_Step}.' curve='.$suximage->{_curve};
...
=cut
 ...
 sub curvecolor {
	...
	if ( $curvecolor ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' curvecolor='.$suximage->{_curvecolor};
		$suximage->{_Step}		= $suximage->{_Step}.' curvecolor='.$suximage->{_curvecolor};
...
=cut
 ...
 sub curvefile {
	...
	if ( $curvefile ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' curvefile='.$suximage->{_curvefile};
		$suximage->{_Step}		= $suximage->{_Step}.' curvefile='.$suximage->{_curvefile};
...
=cut
 ...
 sub d1num {
	...
	if ( $d1num ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' d1num='.$suximage->{_d1num};
...
=cut
 ...
 sub d2num {
	...
	if ( $d2num ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' d2num='.$suximage->{_d2num};
...
=cut
 ...
 sub f1num {
	...
	if ( $f1num ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' f1num='.$suximage->{_f1num};
...
=cut
 ...
 sub f2num {
	...
	if ( $f2num ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' f2num='.$suximage->{_f2num};
...
=cut
 ...
 sub first_distance_sample_value  {
	...
	if ( $f2 ) {
		...
		print("ximage, first_distance_sample_value , missing first_distance_sample_value ,\n");
	 }
 }
...
=cut
 ...
 sub first_time_sample_value {
	...
	if ( $f1 ) {
		...
		print("ximage, first_time_sample_value, missing first_time_sample_value,\n");
	 }
 }
...
=cut
 ...
 sub grid1 {
	...
	if ( $grid1 ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' grid1='.$suximage->{_grid1};
		$suximage->{_Step}		= $suximage->{_Step}.' grid1='.$suximage->{_grid1};
...
=cut
 ...
 sub grid2 {
	...
	if ( $grid2 ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' grid2='.$suximage->{_grid2};
		$suximage->{_Step}		= $suximage->{_Step}.' grid2='.$suximage->{_grid2};
...
=cut
 ...
 sub gridcolor {
	...
	if ( $gridcolor ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' gridcolor='.$suximage->{_gridcolor};
		$suximage->{_Step}		= $suximage->{_Step}.' gridcolor='.$suximage->{_gridcolor};
...
=cut
 ...
 sub label1 {
	...
	if ( $label1 ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' label1='.$suximage->{_label1};
		$suximage->{_Step}		= $suximage->{_Step}.' label1='.$suximage->{_label1};
...
=cut
 ...
 sub label2 {
	...
	if ( $label2 ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' label2='.$suximage->{_label2};
		$suximage->{_Step}		= $suximage->{_Step}.' label2='.$suximage->{_label2};
...
=cut
 ...
 sub labelcolor {
	...
	if ( $labelcolor ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' labelcolor='.$suximage->{_labelcolor};
		$suximage->{_Step}		= $suximage->{_Step}.' labelcolor='.$suximage->{_labelcolor};
...
=cut
 ...
 sub labelfont {
	...
	if ( $labelfont ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' labelfont='.$suximage->{_labelfont};
		$suximage->{_Step}		= $suximage->{_Step}.' labelfont='.$suximage->{_labelfont};
...
=cut
 ...
 sub legend {
	...
	if ( $legend ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' legend='.$suximage->{_legend};
		$suximage->{_Step}		= $suximage->{_Step}.' legend='.$suximage->{_legend};
...
=cut
 ...
 sub legendfont {
	...
	if ( $legendfont ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' legendfont='.$suximage->{_legendfont};
		$suximage->{_Step}		= $suximage->{_Step}.' legendfont='.$suximage->{_legendfont};
...
=cut
 ...
 sub lheight {
	...
	if ( $lheight ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' lheight='.$suximage->{_lheight};
		$suximage->{_Step}		= $suximage->{_Step}.' lheight='.$suximage->{_lheight};
...
=cut
 ...
 sub lolip {
	...
	if ( $wclip ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' wclip='.$suximage->{_wclip};
		$suximage->{_Step}		= $suximage->{_Step}.' wclip='.$suximage->{_wclip};
...
=cut
 ...
 sub lwidth {
	...
	if ( $lwidth ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' lwidth='.$suximage->{_lwidth};
		$suximage->{_Step}		= $suximage->{_Step}.' lwidth='.$suximage->{_lwidth};
...
=cut
 ...
 sub mpicks {
	...
	if ( $mpicks ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' mpicks='.$suximage->{_mpicks};
		$suximage->{_Step}		= $suximage->{_Step}.' mpicks='.$suximage->{_mpicks};
...
=cut
 ...
 sub n2tic {
	...
	if ( $n2tic ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' n2tic='.$suximage->{_n2tic};
		$suximage->{_Step}		= $suximage->{_Step}.' n2tic='.$suximage->{_n2tic};
...
=cut
 ...
 sub npair {
	...
	if ( $npair ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' npair='.$suximage->{_npair};
...
=cut
 ...
 sub num_minor_ticks_betw_distance_ticks {
	...
	if ( $n2tic ) {
		...
		print("ximage, num_minor_ticks_betw_distance_ticks, missing num_minor_ticks_betw_distance_ticks,\n");
	 }
 }
...
=cut
 ...
 sub num_minor_ticks_betw_time_ticks {
	...
	if ( $n1tic ) {
		...
		print("ximage, num_minor_ticks_betw_time_ticks, missing num_minor_ticks_betw_time_ticks,\n");
	 }
 }
...
=cut
 ...
 sub orientation{
	...
	if ( $style ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' style='.$suximage->{_style};
		$suximage->{_Step}		= $suximage->{_Step}.' style='.$suximage->{_style};
...
=cut
 ...
 sub percent4clip{
	...
	if ( $perc ) {
		...
		print("ximage, percent4clip, missing percent4clip,\n");
	 }
 }
...
=cut
 ...
 sub picks {
	...
	if ( $mpicks ) {
		...
		print("ximage, picks, missing picks,\n");
	 }
 }
...
=cut
 ...
 sub plotfile {
	...
	if ( $plotfile ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' plotfile='.$suximage->{_plotfile};
		$suximage->{_Step}		= $suximage->{_Step}.' plotfile='.$suximage->{_plotfile};
...
=cut
 ...
 sub tend_s {
	...
	if ( $x1end ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' x1end='.$suximage->{_x1end};
		$suximage->{_Step}		= $suximage->{_Step}.' x1end='.$suximage->{_x1end};
...
=cut
 ...
 sub title {
	...
	if ( $title ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' title='.$suximage->{_title};
		$suximage->{_Step}		= $suximage->{_Step}.' title='.$suximage->{_title};
...
=cut
 ...
 sub titlecolor {
	...
	if ( $titlecolor ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' titlecolor='.$suximage->{_titlecolor};
		$suximage->{_Step}		= $suximage->{_Step}.' titlecolor='.$suximage->{_titlecolor};
...
=cut
 ...
 sub titlefont {
	...
	if ( $titlefont ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' titlefont='.$suximage->{_titlefont};
		$suximage->{_Step}		= $suximage->{_Step}.' titlefont='.$suximage->{_titlefont};
...
=cut
 ...
 sub tstart_s {
	...
	if ( $x1beg ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' x1beg='.$suximage->{_x1beg};
		$suximage->{_Step}		= $suximage->{_Step}.' x1beg='.$suximage->{_x1beg};
...
=cut
 ...
 sub units {
	...
	if ( $units ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' units='.$suximage->{_units};
		$suximage->{_Step}		= $suximage->{_Step}.' units='.$suximage->{_units};
...
=cut
 ...
 sub verbose {
	...
	if ( $verbose ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' verbose='.$suximage->{_verbose};
		$suximage->{_Step}		= $suximage->{_Step}.' verbose='.$suximage->{_verbose};
...
=cut
 ...
 sub windowtitle {
	...
	if ( $windowtitle ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' windowtitle='.$suximage->{_windowtitle};
		$suximage->{_Step}		= $suximage->{_Step}.' windowtitle='.$suximage->{_windowtitle};
...
=cut
 ...
 sub wperc {
	...
	if ( $wperc ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' wperc='.$suximage->{_wperc};
		$suximage->{_Step}		= $suximage->{_Step}.' wperc='.$suximage->{_wperc};
...
=cut
 ...
 sub x2end {
	...
	if ( $x2end ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' x2end='.$suximage->{_x2end};
		$suximage->{_Step}		= $suximage->{_Step}.' x2end='.$suximage->{_x2end};
...
=cut
 ...
 sub x2beg {
	...
	if ( $x2beg ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' x2beg='.$suximage->{_x2beg};
		$suximage->{_Step}		= $suximage->{_Step}.' x2beg='.$suximage->{_x2beg};
...
=cut
 ...
 sub y_tick_increment {
	...
	if ( $d1num ) {
		...
		print("ximage, y_tick_increment, missing y_tick_increment,\n");
	 }
 }

...
sub curvefile{
    ...
    $Suximage->{_Step}     = $Suximage->{_Step}.' curve='.$Suximage->{_curvefile};    
...
sub dx_major_divisions {
    ...
    $Suximage->{_Step}       = $Suximage->{_Step}.' d2num='.$Suximage->{_dx_major_divisions}; 
}
...
sub dy_major_divisions {
    ...
    $Suximage->{_dy_major_divisions}      = $dy_major_divisions if defined($dy_major_divisions);		
    $Suximage->{_Step}       = $Suximage->{_Step}.' d1num='.$Suximage->{_dy_major_divisions}; 
}
...
sub hiclip {
    ...
    $Suximage->{_Step}       = $Suximage->{_Step}.' bclip='.$Suximage->{_hiclip};
    $Suximage->{_note}       = $Suximage->{_note}.' hiclip='.$Suximage->{_hiclip};
}
...
sub loclip {
    ...
    $Suximage->{_Step}       = $Suximage->{_Step}.' wclip='.$Suximage->{_loclip}; 
    $Suximage->{_note}       = $Suximage->{_note}.' loclip='.$Suximage->{_loclip};
...
sub picks {
    ...
    $Suximage->{_Step}       = $Suximage->{_Step}.' mpicks='.$Suximage->{_picks};    
...
sub title {
    ...
    if ($title == $on) {
       $Suximage->{_Step}       = $Suximage->{_Step}.' title='.$Suximage->{_note};  
    } else {

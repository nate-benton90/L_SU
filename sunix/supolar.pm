...
sub new {
    my $class = shift;
    my $supolar = {
        _output_amplitude,  		   => shift,
        _amp,  		   		   => shift,
        _angle_units,   		   => shift,
        _angle,   		   	   => shift,
        _azimuth_principal_axes,           => shift,
        _phi,           		   => shift,
        _base_file_name,     	  	   => shift,
        _file,     	  	   	   => shift,
        _correlation_window_width_s,       => shift,
        _wl,            		   => shift,
        _correlation_window_type,      	   => shift,
        _win,      	   		   => shift,
        _default_values,   		   => shift,
        _all,   		   	   => shift,
        _flatness,   			   => shift,
        _f1,   			   	   => shift,
        _global_parameter,   		   => shift,
        _tau,   		   	   => shift,
        _incidence_angle_principal_axis,   => shift,
        _theta,   			   => shift,
        _linearity,   			   => shift,
        _l1,   			   	   => shift,
        _note,                             => shift,
        _components_polarization,          => shift,
        _dir,   			   => shift,
        _planarity,   			   => shift,
        _pln,   			   => shift,
        _rectilinearity,  	           => shift,
        _rl,  	           		   => shift,
        _rectilinearity_contrast,   	   => shift,
        _rlq,   	   		   => shift,
        _Step,                             => shift,
        _verbose,   			   => shift,
        _output_ellipticities,   	   => shift,
        _ellip,   	   		   => shift
    };
         bless $supolar, $class;
	 initiate();
...
sub base_file_name {
    ...
    $supolar->{_note}        		= $supolar->{_note}.' file='.$supolar->{_base_file_name};
    $supolar->{_Step}        		= $supolar->{_Step}.' file='.$supolar->{_base_file_name};
}
...
sub global_parameter {
    ...
    $supolar->{_global_paramter} 	= $global_paramter if defined($global_parameter);

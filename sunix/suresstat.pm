...
=cut
 ...
 sub input_file {
   ...
   if($input_file) {
    ...
    $suresstat->{_Step}   	= $suresstat->{_Step}.' fn='.$suresstat->{_input_file} ;
    $suresstat->{_note}   	= $suresstat->{_note}.' input_file='.$suresstat->{_input_file} ;
   }
...
=cut
 ...
 sub max_fldr_cdp_tracf {
   ...
   if($max_fldr_cdp_tracf) {
    ...
    $suresstat->{_Step}       		= $suresstat->{_Step}.' imax='.$suresstat->{_max_fldr_cdp_tracf} ;
    $suresstat->{_note}     		= $suresstat->{_note}.' max_fldr_cdp_tracf='.$suresstat->{_max_fldr_cdp_tracf} ;
   }
}
...
=cut
 ...
 sub iterations {
   ...
   if($iterations) {
    ...
    $suresstat->{_Step}         = $suresstat->{_Step}.' niter='.$suresstat->{_iterations} ;
    $suresstat->{_note}         = $suresstat->{_note}.' iterations='.$suresstat->{_iterations} ;
   }
}
...
=cut
 ...
 sub max_sample_shift {
   ...
   if($max_sample_shift) {
    ...
    $suresstat->{_Step}       		= $suresstat->{_Step}.' ntpick='.$suresstat->{_max_sample_shift} ;
    $suresstat->{_note}       		= $suresstat->{_note}.' max_sample_shift='.$suresstat->{_max_sample_shift} ;
   }
}
...
sub receiver_statics_file_output {
    ...
    if ($receiver_statics_file_output ) {
        $suresstat->{_receiver_statics_file_output}  = $receiver_statics_file_output ;
        print 'receiver_statics_file_output='.$receiver_statics_file_output."\n\n";    
    	$suresstat->{_Step}     = $suresstat->{_Step}.' rsol='.$suresstat->{_receiver_statics_file_output} ;
    	$suresstat->{_note}     = $suresstat->{_note}.' receiver_statics_file_output='.$suresstat->{_receiver_statics_file_output} ;
        }
     }
...
sub rsol {
    ...
    if ($rsol ) {
    	...
    	$suresstat->{_note}     = $suresstat->{_note}.' receiver_statics_file_output='.$suresstat->{_rsol} ;
        }
     }
...
sub source_statics_file_output {
    ...
    if ($source_statics_file_output){
        ...
        print 'source_statics_file_output='.$source_statics_file_output."\n\n";        
        $suresstat->{_Step}       = $suresstat->{_Step}.' ssol='.$suresstat->{_source_statics_file_output} ;
        $suresstat->{_note}       = $suresstat->{_note}.' ssol='.$suresstat->{_source_statics_file_output} ;
    }
}
...
sub ssol {
    ...
    if ($ssol){
        ...
        $suresstat->{_note}       = $suresstat->{_note}.' source_statics_file_output='.$suresstat->{_ssol} ;
    }
}
...
sub subtract {
    ...
    if ($subtract){
        ...
        $suresstat->{_Step}       = $suresstat->{_Step}.' sub='.$suresstat->{_subtract} ;
        $suresstat->{_note}       = $suresstat->{_note}.' subtract='.$suresstat->{_subtract} ;
    }
}

...
=cut
 ...
 sub first_distance_sample_value  {
	...
	if ( $f2 ) {
		...
		print("suximage, first_distance_sample_value , missing first_distance_sample_value ,\n");
	 }
 }
...
=cut
 ...
 sub first_time_sample_value {
	...
	if ( $f1 || $f1 == 0) {
		...
		print("suximage, first_time_sample_value, missing first_time_sample_value,\n");
	 }
 }
...
=cut
 ...
 sub num_minor_ticks_betw_distance_ticks {
	...
	if ( $n2tic ) {
		...
		print("suximage, num_minor_ticks_betw_distance_ticks, missing num_minor_ticks_betw_distance_ticks,\n");
	 }
 }
...
=cut
 ...
 sub num_minor_ticks_betw_time_ticks {
	...
	if ( $n1tic ) {
		...
		print("suximage, num_minor_ticks_betw_time_ticks, missing num_minor_ticks_betw_time_ticks,\n");
	 }
 }
...
=cut
 ...
 sub tmpdir {
	...
	if ( $tmpdir ) {
		...
		$suximage->{_note}		= $suximage->{_note}.' tmpdir='.$suximage->{_tmpdir};
		$suximage->{_Step}		= $suximage->{_Step}.' tmpdir='.$suximage->{_tmpdir};

...
#     
#  	for (my $i=0; $i<=$index;$i++) {
#     	print("param_flow_pink,stack_names_aref2, an accumulating array of arrays: @{$param_flow->{_names_aref2}} item $i\n");
#  	} 
...
sub view_data {
    ...
    $num_progs[5] = scalar  ( @{$param_flow->{_prog_names_aref}});
	 ...
	 print("\nparam_flow,_prog_names @{$param_flow->{_prog_names_aref}}\n");
   	 ...
   	 # print("param_flow,view_data, param_flow_pink_ has hash=$param_flow\n ");

...
#		 print("L_SU, _get_unoccupied_listbox, current occupied color =  $color \n");
#		 print("1 L_SU,_get_unoccupied_listbox, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n");
...
#			 print("10 L_SU,_get_unoccupied_listbox, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n");
			return($color);	
		 	...
		 	# print("L_SU, _get_unoccupied_listbox, All boxes are full\n");		 
		 	$color 		= 'grey' ;
		 ...
		 print("L_SU, _get_unoccupied_listbox, missing $L_SU_gui->{_occupied_listbox_aref}\n");		
		}
 }
...
=cut
 ...
 sub _set_occupied_listbox_aref {
 	...
 	if ($L_SU_gui->{_occupied_listbox_aref}) {
 		...
 		# CASE where not flow color exists..default to grey
 		if ($flow_color)     {
 			...
 			if ($flow_color eq '' ) {	
   			...
   			# CASE perl flow selction when no of listboxes are occupied
	...
	if ($dialog_type_sref)  {
		...
		# when coming from only sunix-selected before FLow
			...
			_set_user_built_flow_type();
		     	...
		     	# print("4 L_SU, FileDialog_button, unoccupied color = $which_color \n");
		...
		if ( not $color) {
			...
			$color = _get_flow_color(); 
			 ...
			 print("L_SU, FileDialog_button, color already exists: $color \n");
		}
		
		# CASES 3A-3D	user-built flows in color	
 		# can = 'neutral', when flow listbox is not a color if sunix_select has been chosen
		...
		if ( $color && ( $L_SU -> {_is_flow_listbox_grey_w}  	||
 			...
 			_set_occupied_listbox_aref();
 			# CASE 3A											   								   							  	
 			if ( $L_SU->{_is_flow_listbox_grey_w} &&  $color eq 'grey' ) { # more certainty
			
		 		
 		 		# mark the neutral-colored flow as unused		
 		 		# helps bind flow parameters to the opening files
# 		 			print("60 L_SU, FileDialog_button, CASE 3A color is $color\n");
...
#				
#						print("L_SU, FileDialog_button, case 3B. color is $color\n");
...
# 						print("3 L_SU,FileDialog_button,_flow_name_green_w:	$L_SU->{_flow_name_green_w} \n");			
  		 	...
  		 	# CASE 3D		
 				...
 				$L_SU->{_flow_color} 	= $blue_flow ->get_flow_color();
 							...
 							# print("L_SU, FileDialog_button, case 3D. color is $color\n");
 			} else {
...
=cut
 ...
 sub user_built_flows  {
 	...
 	if ( $color eq 'grey' ) {					
		...
		$grey_flow 						-> set_hash_ref($L_SU);  # uses 46/ 115 in
		$grey_flow						-> set_occupied_listbox_aref($L_SU_gui->{_occupied_listbox_aref});
 		...
 		$L_SU							=  $grey_flow->get_hash_ref();
  		...
  		_set_occupied_listbox_aref();
 		 		 ...
 		 		 # print("2 L_SU, grey_flow: $grey_flow\n");
  		 		 # print("21 L_SU,user_built_flows,_flow_listbox_grey_w:	$L_SU->{_flow_listbox_grey_w} \n");
 		 		 # print("2. L_SU,user_built_flows, color: $L_SU->{_flow_color},method: $method\n");
 		 		 # print("2. L_SU, grey_flow:_is_last_flow_index_touched: $L_SU->{_is_last_flow_index_touched}\n");
 		 		 # print("22 L_SU,user_built_flows,_flow_listbox_grey_w:	$L_SU->{_flow_listbox_grey_w} \n");
 		 		 
  			# print("1 L_SU,user_built_flows,_is_flow_listbox_grey_w:	$L_SU->{_is_flow_listbox_grey_w} \n");
 			# print("1 L_SU,user_built_flows,_is_flow_listbox_pink_w:	$L_SU->{_is_flow_listbox_pink_w} \n");
 			# print("1 L_SU,user_built_flows,_is_flow_listbox_green_w:	$L_SU->{_is_flow_listbox_green_w} \n");
 			# print("1 L_SU,user_built_flows,_is_flow_listbox_blue_w:	$L_SU->{_is_flow_listbox_blue_w} \n");
 			#  print("11 L_SU,user_built_flows, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n"); 		 		 
 		 		  		
 	} elsif ($color eq 'pink') {
 			# print("30 L_SU,user_built_flows, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n");  					
 		$pink_flow 						-> set_hash_ref($L_SU);  # uses 46/ 115 in
 		$pink_flow						-> set_occupied_listbox_aref($L_SU_gui->{_occupied_listbox_aref});
		$pink_flow 						-> $method;
  		$L_SU							= $pink_flow->get_hash_ref();
  		_set_occupied_listbox_aref();
  		
  			# print("3 L_SU,user_built_flows,_is_flow_listbox_grey_w:	$L_SU->{_is_flow_listbox_grey_w} \n");
 			# print("3 L_SU,user_built_flows,_is_flow_listbox_pink_w:	$L_SU->{_is_flow_listbox_pink_w} \n");
 			# print("3 L_SU,user_built_flows,_is_flow_listbox_green_w:	$L_SU->{_is_flow_listbox_green_w} \n");
 			# print("3 L_SU,user_built_flows,_is_flow_listbox_blue_w:	$L_SU->{_is_flow_listbox_blue_w} \n");
 			# print("31 L_SU,user_built_flows, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n"); 		
  		 				# print("32 L_SU,user_built_flows,_is_flow_listbox_pink_w:	$L_SU->{_is_flow_listbox_pink_w} \n");
  		 				# print("1. L_SU,user_built_flows  color: $color\n");
 						# print("3 L_SU,user_built_flows,_is_flow_listbox_grey_w:	$L_SU->{_is_flow_listbox_grey_w} \n");	
 							
 	} elsif ($color eq 'green') {	# needed?
 			# print("40 L_SU,user_built_flows, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n");
 		$green_flow 					-> set_hash_ref($L_SU);  # uses 46/ 115 in
  		$green_flow						-> set_occupied_listbox_aref($L_SU_gui->{_occupied_listbox_aref});
 		$green_flow 					-> $method;
 		$L_SU							= $green_flow->get_hash_ref(); 
   		_set_occupied_listbox_aref();
   							
  			# print("4 L_SU,user_built_flows,_is_flow_listbox_grey_w:	$L_SU->{_is_flow_listbox_grey_w} \n");
 			# print("4 L_SU,user_built_flows,_is_flow_listbox_pink_w:	$L_SU->{_is_flow_listbox_pink_w} \n");
 			# print("4 L_SU,user_built_flows,_is_flow_listbox_green_w:	$L_SU->{_is_flow_listbox_green_w} \n");
 			# print("4 L_SU,user_built_flows,_is_flow_listbox_blue_w:	$L_SU->{_is_flow_listbox_blue_w} \n");	
 						# print("3. L_SU,user_built_flows  color: $L_SU->{_flow_color}, method: $method \n");
 			# print("41 L_SU,user_built_flows, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n");
 			 		
 	} elsif ($color eq 'blue') { 	# needed?
 	
 			# print("1. L_SU,user_built_flows  color: $color\n");
  			# print("50 L_SU,user_built_flows, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n"); 			
 		$blue_flow 						-> set_hash_ref($L_SU);  # uses 46/ 115 in
 	...
 	# for sunix_select	
 			...
 			# print("60 L_SU,user_built_flows, occupied_listboxes: @{$L_SU_gui->{_occupied_listbox_aref}}\n"); 	
 		$neutral_flow 				-> set_hash_ref($L_SU);
 		$neutral_flow 				-> $method;
 		$L_SU->{_last_flow_color}	= $neutral_flow->get_last_flow_color();	# bring back last_flow_color

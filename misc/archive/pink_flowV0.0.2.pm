...
sub sunix_select (this subroutine is only active in neutral_flow.pm)
...
=cut 
	...
	use conditions_gui;
 	...
 	my $param_flow     		= param_flow_grey 	->new();
 			# print("pink flow, make param_flow instance in pink flow\n");
...
sub _add2flow {
	...
	$userBuiltFlow->{_flow_type} = $flow_type->{_user_built};
	 	# print("1. pink_flow, add2flow_button, color: $flow_color \n");
	 	# print("2. pink_flow, add2flow_button, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
		# print("3. pink_flow add2flow_button: _last_parameter_index_touched $userBuiltFlow->{_last_parameter_index_touched}\n");
	...
	my $userBuiltFlow_messages 	= message_director->new();
  	...
  	my $here;
 	 		# print("pink_flow,_add2flow, labels: @{$userBuiltFlow->{_names_aref}}\n");  	
  	    	# print("4. pink_flow, add2flow_button, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
 			# print("pink_flow,_add2flow,check_buttons_settings : @{$userBuiltFlow->{_check_buttons_settings_aref}}\n");
  	$conditions_gui				-> set_gui_widgets($userBuiltFlow);  	# 26 used  / 113 in
 	$conditions_gui				-> set_hash_ref($userBuiltFlow);	 	# 62 used / 113 in
	...
	$userBuiltFlow				= $conditions_gui-> get_hash_ref();  	# 88 returned	
	 			...
	 			# print("5. pink_flow, add2flow_button, color: $flow_color \n"); 	
 	$message_w   				->delete("1.0",'end');
 	$message_w   				->insert('end', $message);	
			 
    			# print("6. pink_flow, add2flow_button, _prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}}\n"); 
    			# print("7. pink_flow, add2flow_button, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
    ...
    _set_flow_listbox_color_w($flow_color); # in "color"_flow namespace
   				...
   				# print("8. pink_flow, add2flow_button, _is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");
   				# print("9. pink_flow,add2flow_button,userBuiltFlow->listbox_widget: $userBuiltFlow->{_flow_listbox_color_w}\n");
   	...
   	$userBuiltFlow->{_flow_listbox_color_w} ->insert(
    		...
    		# because focus is transferred to a flow list box  (pink, pink,green or blue)
    				  
	$here 				= $whereami->set4add2flow();   # checking 		
   		 		# print("13. pink_flow, add2flow_button, color: $flow_color \n");
   		 		# print (" pink_flow, _add2flow, _is_add2flow: $userBuiltFlow->{_is_add2flow}\n");
	...
	# no. of parameters defaults to max=113
	...
	$param_widgets		->gui_full_clear();
   	...
   	$param_widgets		->redisplay_values();
   				 # print("14. pink_flow, add2flow, labels or names @{$userBuiltFlow->{_names_aref}}\n");   	  			
   	  		 	 # print("15. pink_flow, add2flow, flow color $flow_color \n");

   	$param_widgets		->redisplay_check_buttons();
  		  		 # print("16. pink_flow, add2flow_button, _labels_w_aref @{$userBuiltFlow->{_labels_w_aref}}\n");
	  			 # print("17.  pink_flow, add2flow_button, _values_w_aref {$userBuiltFlow->{_values_w_aref}}\n");
   ...
   _stack_versions();
   	...
   	_stack_flow();
	 			# print("18. pink_flow, add2flow_button, _values_w_aref @{$userBuiltFlow->{_values_w_aref}}}[0]\n");   	
   	$conditions_gui			-> set_gui_widgets($userBuiltFlow); 	# includes _values_w_aref; 29 used / 113 in
 	$conditions_gui			-> set_hash_ref($userBuiltFlow);		# 70 used / 113 in
	$conditions_gui    		-> set4end_of_add2flow($flow_color);
				 # print("19. pink_flow add2flow_button: _last_parameter_index_touched $userBuiltFlow->{_last_parameter_index_touched}\n");
	 			 # print("4 pink_flow,add2flow_button,_flowNsuperflow_name_w : $userBuiltFlow->{_flowNsuperflow_name_w} \n"); 
	 			
	my $index 				= $flow_widgets->get_flow_selection($userBuiltFlow->{_flow_listbox_color_w});
							 # print("20.pink_flow _add2flow,last flow program touched had index: $index\n");
							 # print("21. pink_flow, add2flow_button, color: $flow_color \n");
	$conditions_gui			-> set_flow_index_last_touched($index); # flow color is not reset
#	
	$userBuiltFlow 			=  $conditions_gui->get_hash_ref();
	 	 		# print("5 pink_flow,add2flow_button,_flowNsuperflow_name_w : $userBuiltFlow->{_flowNsuperflow_name_w} \n");
...
# 		print("\n1. pink_flow flow_select, program name is $userBuiltFlow->{_prog_name_sref}\n");
# 	}
#
...
#           print (" pink_flow_flowkey is $key, value is $userBuiltFlow->{$key}\n");
#          }
#    	     	 
...
#    	  foreach my $key (sort keys %$userBuiltFlow) {
#           print ("pink_flow, key is $key, value is $userBuiltFlow->{$key}\n");
#          }	  
#          
#    Important variables:
...
#	use messages::message_director;
#	use decisions;  
#					print("1. pink_flow, _flow_select, _is_flow_listbox_pink_w:$userBuiltFlow->{_is_flow_listbox_pink_w}\n");
#	my $userBuiltFlow_messages 	= message_director->new();
#	my $decisions				= decisions->new();
# 			# print("2. pink_flow,_flow_select,_flowNsuperflow_name_w : $userBuiltFlow->{_flowNsuperflow_name_w} \n");
# 			# print("3 pink_flow,_flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
# 			
# 			 $userBuiltFlow->{_names_aref} 		= $param_flow->get_names_aref();
#  			 print("2. pink_flow _flow_select,parameter names: @{$userBuiltFlow->{_values_aref}}[3]\n");	
#    $userBuiltFlow->{_flow_type} = $flow_type->{_user_built}; 
#			# print("4. pink_flow, _flow_select, array of widgets: _values_w_aref=  @{$userBuiltFlow->{_values_w_aref}}\n");
#			 my $value = @{$userBuiltFlow->{_values_w_aref}}[3]->get;
#			# print("5. pink_flow, _flow_select, first value of first widget: _values_w_aref= $value \n");
#	my $message          		= $userBuiltFlow_messages->null_button(0);
# 	$message_w   				->delete("1.0",'end');
# 	$message_w   				->insert('end', $message);
# 				# print("6. pink_flow, _flow_select,flow color: $userBuiltFlow->{_flow_color} \n");
...
#			print("7. pink_flow, _flow_select, first value of first widget: _values_w_aref= $val \n");
#	
...
#				# print("8. pink_flow, _flow_select,_is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");
# 	my $flow_color				= $userBuiltFlow ->{_flow_color};  # TODO: careful, color is re-assigned from conditions_gui,few lines up
# 				# print("9 pink_flow, _flow_select,_last_flow_listbox_touched_w: $userBuiltFlow->{_last_flow_listbox_touched_w} \n");
# 	 			# print("10. pink_flow,_flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");			
...
#					# print("11. pink_flow, flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");	
#	my $pre_req_ok 	  						= $decisions->get4flow_select();
#					# print ("pink_flow, _flow_select, pre_req_ok: $pre_req_ok\n");
#				 	# print("12 pink_flow,_flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
#	
#	if ($pre_req_ok) {
#		use binding;
...
#    						
#		$userBuiltFlow->{_prog_name_sref} 	= $flow_widgets->get_current_program(\$_flow_listbox_color_w );
# 				 			# print ("8. pink_flow, _flow_select, flow_color: $flow_color\n");
# 				 			# print("13 pink_flow,_flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");		
#							# Is a program deleted through a previous dragNdrop?
#  			if( $flow_widgets->is_drag_deleted($_flow_listbox_color_w ) ) {
#
#			  				 # print("\n\npink_flow_flow_select,something was deleted in previous dragNdrop\n");
#        		my $this_index 		= $flow_widgets->get_drag_deleted_index($_flow_listbox_color_w );
#							 # print("pink_flow_flow_select,deleting flow_listbox,idx=$thi# s_index\n");
#							 # 
...
#			}
#		
#				# print("3. pink_flow, _flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
...
#			# print("5. pink_flow, _flow_select, first value of first widget: _values_aref[0]= $value \n");                    
...
#				# print("pink_flow, _flow_select,_flow_listbox_color_w: $userBuiltFlow->{_flow_listbox_color_w} \n");
#  				# print("pink_flow, _flow_select, current index is $index\n");
#  				# print("pink_flow, _flow_select, last_flow_index_touched:$userBuiltFlow->{_last_flow_index_touched}\n");
#				# print("pink_flow _flow_select: _last_parameter_index_touched $userBuiltFlow->{_last_parameter_index_touched}\n");
#  								
#  							# number of programs in flow
#  		my $num_items 						= $param_flow->get_num_items(); 
# 		$param_flow							->set_flow_index($index);
# 		$userBuiltFlow->{_names_aref} 		= $param_flow->get_names_aref();
#  							# print("2. pink_flow _flow_select,parameter names: @{$userBuiltFlow->{_names_aref}}[0]\n");
#  							
# 		$userBuiltFlow->{_values_aref} 		=	$param_flow->get_values_aref();
#  				 			 # print("3. pink_flow _flow_select,parameter values:@{$userBuiltFlow->{_values_aref}}[0]\n");
#  				 			 
# 		$userBuiltFlow->{_check_buttons_settings_aref} 
#									=  $param_flow->get_check_buttons_settings();
#
#  				 			 # print("4. pink_flow _flow_select, check_buttons_settings no changes, @{$userBuiltFlow->{_check_buttons_settings_aref}}\n");
#  				 			 # print("4. pink_flow _flow_select,index: $index \n");
#  				 			
...
#
# 				 				# print("5. pink_flow, _flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
#				 			  	# print("pink_flow, _flow_select, $userBuiltFlow->{_is_flow_listbox_color_w}\n");
#				 			  	# print("pink_flow, _flow_select, color:$flow_color\n");
#		$whereami				->set4flow_listbox($flow_color);
#		$here 					= $whereami->get4flow_listbox();
#				 			  	# print("5. pink_flow _flow_select,here->{_is_flow_listbox_color_w: $here->{_is_flow_listbox_color_w}\n");
#				 			  	# print("pink_flow, _flow_select, _is_flow_listbox_color_w, $here->{_is_flow_listbox_color_w}\n");
#		 				 	  	# print("6. pink_flow, _flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");	
#								# print("7. pink_flow, _flow_select,_param_flow_first_idx, $userBuiltFlow->{_param_flow_first_idx}\n");	
#								# print("8. pink_flow, _flow_select,_param_flow_length, $userBuiltFlow->{_param_flow_length}\n");	
#						 	 			 
#	    $param_widgets      		->set_location_in_gui($here);
#	    	    	
...
# 		$param_widgets				->set_check_buttons($userBuiltFlow->{_check_buttons_settings_aref});
#										
#					  		 # print("6. pink_flow, _flow_select, is listbox selected:$here->{_is_flow_listbox_color_w}\n");
#		$whereami					->set4flow_listbox($flow_color);
#		$here 						= $whereami->get4flow_listbox();
#							# print("6. pink_flow, _flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
#    	$param_widgets      		->set_location_in_gui($here);
...
#							# print("pink_flow, _flow_select,Entry_widgets@Entry_widget\n");
...
# 		$binding					->set();
#				# print("7. pink_flow, _flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
#
#  		$conditions_gui				-> set_gui_widgets($userBuiltFlow);
# 		$conditions_gui				-> set_hash_ref($userBuiltFlow);
#    	$conditions_gui				-> set4end_of_flow_select($flow_color);
#    	$conditions_gui				-> set_flow_index_last_touched($index);
#   		  		 # print("14 pink_flow,_flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");	
#    	$userBuiltFlow 				= $conditions_gui->get_hash_ref(); # now pink_flow = 0; flow_type=user_built
#    			# print("15. pink_flow,_flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
#    			# print("6. pink_flow,_flow_select,flow_color: $userBuiltFlow->{_flow_color} \n");
#    		
...
#
#				# print("8. pink_flow,_flow_select,_flowNsuperflow_name_w : $userBuiltFlow->{_flowNsuperflow_name_w} \n");
#				# print("16. pink_flow,_flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
#    		
...
=head2
	...
	Other cases that select the GUI file buttons directly use: FileDialog_button
  	...
  	print ("pink_flow,_FileDialog_button(binding), _is_flow_listbox_pink_w: $userBuiltFlow->{_is_flow_listbox_pink_w} \n");
...
=cut 
 ...
 sub _FileDialog_button {   # N.B. change here mean FileDialog_button in L_SU needs to be updated too!!!!!!!
	...
	if ($option_sref)  {  # e.g., can be 'Data'
		...
		# print("pink_flow _FileDialog_button,option_sref $$option_sref\n");

		# provide values in the current widget
		$userBuiltFlow		->{_values_aref}  = $param_widgets	->get_values_aref();
			# print("pink_flow _FileDialog_button,changed values_aref: @{$userBuiltFlow->{_values_aref}}\n");
		...
		$userBuiltFlow->{_is_last_parameter_index_touched} 	= $true;
			 # print ("pink_flow,_FileDialog_button(binding), last_parameter_index_touched: $userBuiltFlow->{_last_parameter_index_touched} \n");
		...
		$userBuiltFlow->{_is_last_flow_index_touched} 	= $true;
 			 # print("pink_flow,_FileDialog_button(binding), last_flow_index_touched:$userBuiltFlow->{_last_flow_index_touched} \n"); 		 		  		
		...
		print("pink_flow,_FileDialog_button (binding),option type missing ")
	}
	return();
 }
...
=head2  _check4flow_changes
	...
	if ($param_widgets->get_entry_change_status && $userBuiltFlow->{_last_flow_index_touched} >= 0) {		
    	  foreach my $key (sort keys %$userBuiltFlow) {
           print (" pink_flowkey is $key, value is $userBuiltFlow->{$key}\n");
...
sub _check4flow_changes {
   ...
   # print("pink_flow check4flow_changes: _last_flow_index_touched $userBuiltFlow->{_last_flow_index_touched}\n");
   # print("pink_flow check4flow_changes: _last_parameter_index_touched $userBuiltFlow->{_last_parameter_index_touched}\n");
	...
	if ( $userBuiltFlow->{_last_flow_index_touched} >= 0  ||
		...
		my $last_idx_chng = $userBuiltFlow->{_last_flow_index_touched} ;
	 					     ...
	 					     # print("pink_flow_check4flow_changes,
	 					     # last changed entry index was $last_idx_chng\n");
  							 # print("pink_flow _check4flow_changes program name is 
  							 # ${$userBuiltFlow->{_prog_name_sref}}\n");
		...
		$userBuiltFlow->{_check_buttons_settings_aref}	= $param_widgets	->get_check_buttons_aref();
  							...
  							# print("pink_flowflow_select,changed values_aref: @{$userBuiltFlow->{_values_aref}}\n");
  							#print("pink_flow_changes4changes,changed names_aref: @{$userBuiltFlow->{_names_aref}}\n");
  							#print(" pink_flowflow_select,changes, check_buttons_settings_aref: @{$userBuiltFlow->{_check_buttons_settings_aref}}\n");
  							#
   		 $param_flow	-> set_flow_index($last_idx_chng);
  						 	     # print("pink_flow check4flow_changes ,store changes in param_flow, last changed entry index $last_idx_chng\n");
		 ...
		 $param_widgets	->set_entry_change_status($false);  # changes are now complete
	 	 						 # print("pink_flow flow_select, set_entry_change_status: to 0\n");
	}  						
...
sub _check4parameter_changes {
	my $self = @_;
   		...
   		# print("B4 pink_flow check4parameter_changes: _last_flow_index_touched $userBuiltFlow->{_last_flow_index_touched}\n");
   		# print("B4 pink_flow check4parameter_changes: _last_parameter_index_touched: $userBuiltFlow->{_last_parameter_index_touched}\n");
	...
	if ( $userBuiltFlow->{_last_parameter_index_touched} >= 0 ){  # N.B., <-1 does exist and means the parameters are untouched
		...
		my $last_parameter_idx_touched = $userBuiltFlow->{_last_parameter_index_touched} ;
	 	...
	 	# print("pink_flow_check4parameter_changes,last changed entry index was $last_parameter_idx_touched \n");
  		# print("pink_flow _check4parameter_changes current program name in use: ${$userBuiltFlow->{_prog_name_sref}}\n"); 		
		...
		$userBuiltFlow->{_check_buttons_settings_aref}	= $param_widgets	->get_check_buttons_aref();
  		...
  		my $_flow_listbox_color_w  		= _get_flow_listbox_color_w();  # user-built_flow in current use
 				# print("pink_flow check4parameter_changes flow_listbox_color_w,: $_flow_listbox_color_w  \n"); 		
  		
   		my $current_flow_listbox_index 	= $flow_widgets->get_flow_selection($_flow_listbox_color_w );
		$param_flow						-> set_flow_index($current_flow_listbox_index);
				# print("pink_flow check4parameter_changes ,current_flow_listbox_index: $current_flow_listbox_index \n");
  						 	    
								# save current values
	  							# print("pink_flow_changes4changes,changed names_aref: @{$userBuiltFlow->{_names_aref}}[0]\n");
		 						# print("pink_flow _check4parameter_changes,changed values_aref: @{$userBuiltFlow->{_values_aref}}[0]\n");
		 ...
		 $param_widgets	->set_entry_change_status($false);  # changes are now complete
	 	 						# print("pink_flow ,check4parameter_changes, set_entry_change_status: back to 0 (default)\n");
	 	...
	 	# print("End of pink_flow check4changes: _last_flow_index_touched $userBuiltFlow->{_last_flow_index_touched}\n");
   		# print("End of pink_flow check4changes: _last_parameter_index_touched reset: $userBuiltFlow->{_last_parameter_index_touched}\n");
	}  						
...
=cut 
 ...
 sub _get_flow_listbox_color_w {
	...
	if ($flow_color eq 'grey') {
		...
		print("pink_flow, _get_flow_listbox_color_w, neutral color\n");
	} else {
		print("pink_flow, _get_flow_listbox_color_w, missing color\n");
 ...
 sub _move_in_stored_flows {
	...
	$userBuiltFlow->{_index2move}        	= $flow_widgets->index2move();
  	...
  	my $end	    = $userBuiltFlow->{_destination_index};
   			 print("pink_flow_move_in_stored_flows,start index is the $start\n");
   			 print("pink_flow_move_in_stored_flows, insertion index is $end \n");
...
=head2 sub _SaveAs_button
	...
	topic: only for 'SaveAs'
  	for safety, place set_hash_ref first
   	...
   	my	$m          	= "pink_flow, _SaveAs_button, Test,set_specs,message,$message_w\n";
 	$message_w->delete("1.0",'end');
...
=cut
 ...
 sub _SaveAs_button {
	...
	if ($topic eq 'SaveAs') {
		...
		$conditions_gui			->set_hash_ref($userBuiltFlow);       # 57 used of 113 in
		$conditions_gui			->set_gui_widgets($userBuiltFlow);	  # 26 used of 113 in
		$conditions_gui			->set4_start_of_SaveAs_button();

		my $num_items 			= $param_flow->get_num_items();
  			# print("1. pink_flow, _SaveAs_button, B4 stored number of prgrams: $num_items\n");
  	 	$userBuiltFlow->{_names_aref} 	= $param_flow->get_names_aref();
  			# print("2. pink_flow ,_SaveAs_button parameter names: @{$userBuiltFlow->{_names_aref}}[0]\n");
		...
		$userBuiltFlow->{_prog_names_aref} 		= $param_flow->get_flow_prog_names_aref();
		 		 ...
		 		 # print("pink_flow,_prog_names_aref,
		...
		# my $num_items4flow = scalar @{$userBuiltFlow->{_good_labels_aref2}};
 		...
 		$files_LSU	->set_prog_param_labels_aref2($userBuiltFlow);	# uses x / 113 in
 		$files_LSU	->set_prog_param_values_aref2($userBuiltFlow);	# uses x / 113 in
 		$files_LSU	->set_prog_names_aref($userBuiltFlow);			# uses x / 113 in
 		$files_LSU	->set_items_versions_aref($userBuiltFlow);		# uses x / 113 in
 		$files_LSU	->set_data();
 		$files_LSU	->set_message($userBuiltFlow);  				# uses 1 / 113 in
		...
		$userBuiltFlow 			= $conditions_gui->get_hash_ref(); # 79 out
			# print("1. pink_flow, _SaveAs_button, has_used_SaveAs_button: $userBuiltFlow->{_has_used_SaveAs_button}\n");
 	
 		return();
 		
	} else {		
		print("pink_flow,_SaveAs_button, missing topic\n");
	}		
 } 	
  ...
  call:
    ...
    $conditions_gui	->set4end_of_sunix_select() ;
     $userBuiltFlow 			= $conditions_gui->get_hash_ref();
   		...
   		print("pink_flow,perl_flow, length = $length\n");
   		
   		for (my $j=0; $j <$length; $j++) {
   			   	print("pink_flow,perl_flow,name & value:@{$all_names_aref}[$j] = @{$all_values_aref}[$j]\n");
...
sub _perl_flow {	
    ...
    my $message          	= $userBuiltFlow_messages->null_button(0);
 	...
 	$message_w   			->insert('end', $message);  	
   		...
   		# should be at start of pink_flow
   	$userBuiltFlow->{_flow_type} 	= $flow_type->{_user_built};
   	my $flow_name_in				= $userBuiltFlow->{_flow_name_in};
   	 		
   	  	 # print("pink_flow, _perl_flow ,flow_name_in $flow_name_in\n");  	  	   	 		 	 	
		 # print("pink_flow,1. _perl_flow,flow_color: $userBuiltFlow->{_flow_color}\n"); 	
   	  	     
#    $conditions_gui						    ->set_gui_widgets($userBuiltFlow);
#    $conditions_gui							->set4start_of_perl_select();

    my $flow_color		 = $userBuiltFlow->{_flow_color};
 				# print("pink_flow,2. _perl_flow,flow_color: $flow_color\n"); 
    ...
    my $_flow_listbox_color_w 	= _get_flow_listbox_color_w();
    	...
    	# $flow_widgets	->clear($flow_listbox_pink_w);
    	
    $flow_widgets	->clear($_flow_listbox_color_w );
    
    			# print("pink_flow,flow_listbox_pink_w, $flow_listbox_pink_w, _perl_flow\n");
    ...
    for (my $prog_idx=0; $prog_idx< $num_prog_names; $prog_idx++) {
    	...
    	$userBuiltFlow->{_names_aref}  					= $perl_flow	->get_all_names_aref();
   		...
   		$userBuiltFlow->{_check_buttons_settings_aref}  = $perl_flow	->get_check_buttons_settings_aref();
   				...
   				# print("pink_flow,_perl_flow, #names = $names\n");
   		
   				# print("pink_flow,_perl_flow,prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}}\n");
	 			# print("pink_flow,_perl_flow, values: @{$userBuiltFlow->{_values_aref}}\n");
	 			# print("pink_flow,_perl_flow, labels: @{$userBuiltFlow->{_names_aref}}\n");	
				# print("pink_flow,_perl_flow,_check_buttons_settings: @{$userBuiltFlow->{_check_buttons_settings_aref}}\n"); 		
...
=cut 
 ...
 sub _set_flow_color {
	...
	if ($flow_color) {
		# print("pink_flow _set_flow_color , color:$flow_color\n");
		$userBuiltFlow->{_flow_color}  			 = $flow_color;
		
	} else  {
	 	print("pink_flow, set_flow_color, missing color\n");
	}
	return();
 }
 ...
 sub _set_flow_listbox_color_w {
	...
	if ($flow_color eq 'grey') {
		$userBuiltFlow->{_flow_listbox_color_w} =  $userBuiltFlow->{_flow_listbox_grey_w};
			#print("pink_flow,_set_flow_listbox_color_w, _set_flow_listbox_color_w, color is $flow_color\n");
		...
		$userBuiltFlow->{_flow_listbox_color_w} =  $userBuiltFlow->{_flow_listbox_blue_w};
			#print("pink_flow,set_flow_listbox_color_w, _set_flow_listbox_color_w, color is $flow_color\n");		
	} else {
		print("pink_flow,_set_flow_listbox_color_w, _set_flow_listbox_color_w, missing color\n");
	}
...
=head2 sub _stack_flow
  ...
  print("pink_flow_stack_flow,last left listbox flow program touched had index = $userBuiltFlow->{_last_flow_index_touched}\n");
  print("pink_flow_stack_flow,values= @{$userBuiltFlow->{_values_aref}}\n");
...
sub _stack_flow {
  my( $self) = @_;
       		...
       		# my $num_items = $param_flow->get_num_items();
  			# print("1. pink_flow, _stack_flow, B4 stored number of programs: $num_items\n");
  			# print("pink_flow,_stack_flow,userBuiltFlow->listbox_widget: $userBuiltFlow->{_flow_listbox_color_w}\n");

  			# print("pink_flow, _stack_flow, color: $flow_color \n");
  ...
  $param_flow		->stack_checkbuttons_aref2($userBuiltFlow->{_check_buttons_settings_aref});
  			...
  			# $param_flow 		->view_data();  
   	    	# my $num_items = $param_flow->get_num_items;
  			# print("2. pink_flow, _stack_flow, End- stored programs num_items: $num_items\n");			 
...
sub _stack_versions {
	my $_flow_listbox_color_w 			= _get_flow_listbox_color_w();
	   			# print("pink_flow, _stack_versions ,userBuiltFlow->listbox_widget: $_flow_listbox_color_w \n");
...
=cut 
 ...
 sub FileDialog_button {   # N.B., _FileDialog_button in L_SU.pm (for superflow bindings) needs to be updated too!
	...
	if ($dialog_type_sref)  {
				...
				# print ("2. pink_flow,FileDialog_button, is_last_flow_index_touched: $userBuiltFlow->{_is_last_flow_index_touched} \n");
						
		$userBuiltFlow		->{_dialog_type}  = $$dialog_type_sref;  # dereference scalar
		my $topic 			= $userBuiltFlow ->{_dialog_type};
		
				# print ("2. pink_flow,FileDialog_button,dialog_type: $userBuiltFlow->{_dialog_type}\n");
				# print ("2. pink_flow,set_hash_ref,_flowNsuperflow_name_w:$userBuiltFlow->{_flowNsuperflow_name_w}\n");
		...
		if ($topic eq $file_dialog_type->{_SaveAs} ) {
				...
				# print ("0. pink_flow,FileDialog_button, is_last_parameter_index_touched: $userBuiltFlow->{_is_last_parameter_index_touched} \n");
				# print ("0. pink_flow,FileDialog_button, is_last_flow_index_touched: $userBuiltFlow->{_is_last_flow_index_touched} \n");
			
			$userBuiltFlow		->{_values_aref}  = $param_widgets->get_values_aref();
			$userBuiltFlow		->{_dialog_type}  = $$dialog_type_sref;  # dereference scalar
		
			$file_dialog		->set_flow_color($userBuiltFlow->{_flow_color}); 	# uses 1/ 113 in	 
			$file_dialog 		->set_hash_ref($userBuiltFlow);       				# uses 86/ 113 in  ; uses values_aref
			$file_dialog		->set_gui_widgets($userBuiltFlow);    				# uses 34/ 113 in
			
				# $file_dialog		->set_flow_type('user_built'); not needed beacuase file_dialog accounts forSaveAs
				# print ("1. pink_flow,FileDialog_button, is_last_parameter_index_touched: $userBuiltFlow->{_is_last_parameter_index_touched} \n");
				# print ("1. pink_flow,FileDialog_button, is_last_flow_index_touched: $userBuiltFlow->{_is_last_flow_index_touched} \n");
			
			$file_dialog 		->FileDialog_director();
		
					# print ("2. pink_flow,FileDialog_button, is_last_parameter_index_touched: $userBuiltFlow->{_is_last_parameter_index_touched} \n");
			...
			if( !($userBuiltFlow->{_flow_name_out}) 		||
				...
				# print("1. pink_flow, FileDialog_button, saving flow: $userBuiltFlow->{_flow_name_out}\n");
				...
				# print("pink_flow,FileDialog_button,_flow_name_out: $userBuiltFlow->{_flow_name_out}  \n");
				# print("pink_flow,FileDialog_button,_path: $userBuiltFlow->{_path}  \n");
    		}  #Ends SaveAs option
			...
			# populate hashes (userBuiltFlow)and memory spaces (param_flow)
					# print("3. pink_flow,FileDialog_button,flow_color: $userBuiltFlow->{_flow_color} \n");
					# print("3  pink_flow,FileDialog_button,_flowNsuperflow_name_w:$userBuiltFlow->{_flowNsuperflow_name_w} \n");		
			$file_dialog		->set_flow_color($userBuiltFlow->{_flow_color}); 	# uses 1/ 31 in	 
			$file_dialog 		->set_hash_ref($userBuiltFlow);       # uses 7/ 31 in  ; uses values_aref
			$file_dialog		->set_gui_widgets($userBuiltFlow);    # uses 18/ 31 in
					# print("3  pink_flow,FileDialog_button,_flowNsuperflow_name_w:$userBuiltFlow->{_flowNsuperflow_name_w} \n");
			...
			$userBuiltFlow->{_flow_name_in} 		= $file_dialog->get_perl_flow_name_in();
					# print("4. pink_flow, FileDialog_button,_flow_name_in, $userBuiltFlow->{_flow_name_in} \n");			
			...
			_set_flow_name_color_w ($flow_color);
  			$flow_name_color_w     -> configure(-text => $userBuiltFlow->{_flow_name_in});
   					# $userBuiltFlow->{_flow_name_pink_w}     -> configure(-text => $userBuiltFlow->{_flow_name_in});
			...
			_perl_flow();
					...
					print("pink_flow FileDialog_button,option_sref $topic\n");

			# provide values in the current widget
			$userBuiltFlow		->{_values_aref}  = $param_widgets	->get_values_aref();
				# print("pink_flow FileDialog_button,changed values_aref: @{$userBuiltFlow->{_values_aref}}\n");
			...
			$userBuiltFlow->{_last_flow_index_touched} 		= $current_flow_listbox_index;   # for next time
			$userBuiltFlow->{_is_last_flow_index_touched} 	= $true;
 			 	# print("pink_flow,FileDialog_button(binding), last_flow_index_touched:$userBuiltFlow->{_last_flow_index_touched} \n"); 		 		  		
			...
			print("1. pink_flow, FileDialog_button, missing topic \n");
		   		# Ends opt_ref
			}					
		} else {		
			print("pink_flow,FileDialog_button ,option type missing\ n");
		}
		# print ("2. pink_flow,FileDialog_button, is_last_parameter_index_touched: $userBuiltFlow->{_is_last_parameter_index_touched} \n");
		# print ("2. pink_flow,FileDialog_button, is_last_flow_index_touched: $userBuiltFlow->{_is_last_flow_index_touched} \n");
		return();
...
sub add2flow_button {
    ...
    # append new program names to the end of the list but this item is NOT selected
   	...
   	$userBuiltFlow->{_flow_listbox_color_w} ->insert(
	  		...
	  		# print("10. pink_flow, add2flow_button, _values_w_aref[0] $userBuiltFlow->{_values_w_aref}[0]\n");
	  		#print("11. pink_flow, add2flow_button, _labels_w_aref $userBuiltFlow->{_labels_w_aref}\n");
    ...
    # because focus is transferred to another list box   
   	...
   	$param_sunix									-> set_half_length(); # values not #(values+labels)    	
	 		# print("12. pink_flow, add2flow_button, color: $flow_color \n");
	 		# print("12. pink_flow, add2flow_button, _values_aref @{$userBuiltFlow->{_values_aref}}[1]\n");
	 		my $length = $param_sunix-> get_length();
	 		# print("12. pink_flow, add2flow_button,length_test:$length 	\n");
   	$whereami			->set4add2flow_button();
   		 	# print("13. pink_flow, add2flow_button, color: $flow_color \n");
   	$here                = $whereami->get4add2flow_button();
   	$param_widgets       ->set_location_in_gui($here);
	    		# print("13. pink_flow, add2flow_button, _values_aref @{$userBuiltFlow->{_values_aref}}[1]\n");
	# widgets are initialized in a super class
	# Assign program parameters in the GUI	
	# no. of parameters defaults to max=113
	$param_widgets		->set_labels_w_aref($userBuiltFlow->{_labels_w_aref} );
  	...
  	$param_widgets		->set_check_buttons_w_aref($userBuiltFlow->{_check_buttons_w_aref} );
   	...
   	$param_widgets		->redisplay_labels();
   	$param_widgets		->redisplay_values();
   				# print("14. pink_flow, add2flow_button, _names_aref @{$userBuiltFlow->{_names_aref}}[0]\n");
   	  			
   	  		 	# print("15. pink_flow, add2flow_button, color: $flow_color \n");
   	$param_widgets		->redisplay_check_buttons();
   		  	# print("16. pink_flow, add2flow_button, _labels_w_aref @{$userBuiltFlow->{_labels_w_aref}}[0]\n");
	  		# print("17.  pink_flow, add2flow_button, _values_w_aref {$userBuiltFlow->{_values_w_aref}}\n");
			# print("17. pink_flow, add2flow_button, _values_aref @{$userBuiltFlow->{_values_aref}}[1]\n");
   				# Collect and store prog versions changed in list box
   _stack_versions();
	...
	# as well as the checkbuttons settings (on or off) in another namespace
   	_stack_flow();
	 		# print("18. pink_flow, add2flow_button, _values_w_aref @{$userBuiltFlow->{_values_w_aref}}[0]\n");   	
   			# print("18. pink_flow, add2flow_button, _values_aref @{$userBuiltFlow->{_values_aref}}[1]\n");
   
	  		# print("8. pink_flow, add2flow_button, _is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");
   			# print("8. pink_flow, add2flow_button, _is_flow_listbox_grey_w $userBuiltFlow->{_is_flow_listbox_grey_w}\n");
   			# print("8. pink_flow,add2flow_button,userBuiltFlow->listbox_widget: $userBuiltFlow->{_flow_listbox_color_w}\n");
   
	$conditions_gui			-> set_gui_widgets($userBuiltFlow); 		# includes _values_w_aref; 26 used / 113 in
 	$conditions_gui			-> set_hash_ref($userBuiltFlow);			#  used / 113 in
	$conditions_gui    		-> set4end_of_add2flow_button($flow_color);
		
			# print("19. pink_flow add2flow_button: _last_parameter_index_touched $userBuiltFlow->{_last_parameter_index_touched}\n");
	 		# print("4 pink_flow,add2flow_button,_flowNsuperflow_name_w : $userBuiltFlow->{_flowNsuperflow_name_w} \n"); 
	    	# print("19. pink_flow, add2flow_button, _values_aref @{$userBuiltFlow->{_values_aref}}[1]\n");
	    	
	my $flow_index 				= $flow_widgets->get_flow_selection($userBuiltFlow->{_flow_listbox_color_w});
	
							 # print("20.pink_flow add2flow_button,last flow program touched had index: $flow_index\n");
							 # print("21. pink_flow, add2flow_button, color: $flow_color \n");
	   			# print("8. pink_flow, add2flow_button, _is_flow_listbox_grey_w $userBuiltFlow->{_is_flow_listbox_grey_w}\n");						 
	$conditions_gui			-> set_flow_index_last_touched($flow_index); # flow color is not reset
	
	$userBuiltFlow 			=  $conditions_gui->get_hash_ref();
   			# print("27. pink_flow, add2flow_button, _values_aref @{$userBuiltFlow->{_values_aref}}[1]\n");
	 	 	# print("5 pink_flow,add2flow_button,_flowNsuperflow_name_w : $userBuiltFlow->{_flowNsuperflow_name_w} \n");
	$userBuiltFlow			->{_last_parameter_index_touched} 		= 0; # initialize
	$userBuiltFlow			->{_is_last_parameter_index_touched} 	= $true;
		
				# print("22. pink_flow, add2flow_button, _is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");

				# print("23. pink_flow, add2flow_button, color: $flow_color \n");
	   			# print("24. pink_flow,add2flow_button,userBuiltFlow->listbox_widget: $userBuiltFlow->{_flow_listbox_color_w}\n");
		  		# print("25. pink_flow, add2flow_button, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
   				# print("26. pink_flow,add2flow_button,userBuiltFlow->listbox_widget: $userBuiltFlow->{_flow_listbox_color_w}\n");
		    	# print("27. pink_flow,add2flow_button,last grey-flow program touched had index: $userBuiltFlow->{_last_flow_index_touched}\n");
				# print("28. pink_flow, add2flow_button, _values_w_aref @{$userBuiltFlow->{_values_w_aref}}[1]\n"); 
				# print("29. pink_flow, add2flow_button, _values_aref @{$userBuiltFlow->{_values_aref}}[1]\n");
   				# print("9. pink_flow, add2flow_button, _is_flow_listbox_grey_w $userBuiltFlow->{_is_flow_listbox_grey_w}\n");
   				# print("9. pink_flow,add2flow_button,userBuiltFlow->listbox_widget: $userBuiltFlow->{_flow_listbox_color_w}\n");
   				
	flow_select();	
				# print("10. pink_flow, add2flow_button, _is_flow_listbox_grey_w $userBuiltFlow->{_is_flow_listbox_grey_w}\n");
...
sub delete_from_flow_button {
	...
	my $self = @_;
 	...
 	my $flow_color			= $conditions_gui->get_flow_color();
 				# print("1. pink_flow,delete_from_flow_button, flow_color: $flow_color \n");
 	
 	if ($flow_color)  {
 		_set_flow_color($flow_color);
 					# print("2. pink_flow,delete_from_flow_button, flow_color: $userBuiltFlow->{_flow_color} \n");
		use messages::message_director;
		use decisions 1.00;
		...
		my $message          	= $userBuiltFlow_messages->null_button(0);
 		...
 		my $_flow_listbox_color_w = _get_flow_listbox_color_w();
					# print("1. pink_flow,delete_from_flow_button, flow_listbox_color_w: $_flow_listbox_color_w \n");
		$conditions_gui			->set_hash_ref($userBuiltFlow);    # 57 used  /113 in
		$conditions_gui			->set_gui_widgets($userBuiltFlow); # 26 used  /113 in
		...
		$userBuiltFlow 			= $conditions_gui->get_hash_ref(); # find out if delete button is active    64 returned / 72 max
			...
			# print("1. pink_flow,delete_from_flow_button , is_flow_listbox_pink_w pink green or blue_w: $userBuiltFlow->{_is_flow_listbox_color_w} \n");
		...
		my $pre_req_ok 			= $decisions->get4delete_from_flow_button();
					...
					# print("1. pink_flow,delete_from_flow_button pre_req $pre_req_ok\n");
  		if ($pre_req_ok) {
					 # print("2. pink_flowdelete_from_flow_button pre_req_ok\n");
			...
			if ($index == 0 && $param_flow->get_num_items == 1) {
      				 ...
      				 print("pink_flow,delete_button, last item deleted Shut down delete button\n");
      				 #  Run and Save button
     			$flow_widgets->delete_selection($_flow_listbox_color_w );
   				...
   				$userBuiltFlow->{_is_last_flow_index_touched} 	= $false;
							...
							# print("pink_flowdelete_from_flow_button,
  				...
  				my $index2delete 	= $flow_widgets->get_index2delete();
  					 		# print("pink_flowdelete_from_stored,index2delete:$index2delete\n");
        		...
        		$here				= $whereami->get4delete_from_flow_button();
   				...
   				$userBuiltFlow->{_flowNsuperflow_name_w}-> configure(-text => $var->{_clear_text});
   						# $userBuiltFlow->{_flow_name_pink_w}     -> configure(-text => $var->{_clear_text});
							...
							# note the last program that was touched
							 ...
							 $userBuiltFlow->{_is_last_flow_index_touched} 	= $true;
					   		...
					   		# print("pink_flow_delete_from_flow_button, last index touched :$index..\n");
     			$flow_widgets->delete_selection($_flow_listbox_color_w );

					# delete stored programs and their parameters
   					# delete_from_stored_flows(); 
  				my $index2delete 	= $flow_widgets->get_index2delete();
  					 		#print("2. pink_flowdelete_from_stored,index2delete:$index2delete\n");
  				$param_flow		->delete_selection($index2delete);
            	...
            	if($next_idx_selected_after_deletion == -1) { $next_idx_selected_after_deletion = 0} # NOT < 0
  					  		# print("2. pink_flowdelete_from_flow_button,indexafter_deletion:
  					  		# $next_idx_selected_after_deletion\n");

   		 		$param_flow		-> set_flow_index($next_idx_selected_after_deletion);
 				$userBuiltFlow->{_names_aref} 	= $param_flow->get_names_aref();

  							 # print("2. pink_flow delete_from_flow_button,parameter names 
  							 # is @{$userBuiltFlow->{_names_aref}}\n");
 				$userBuiltFlow->{_values_aref} 	=	$param_flow->get_values_aref();

  				 			 # print("3. pink_flow delete_from_flow_button,parameter values 
  				 			 # is @{$userBuiltFlow->{_values_aref}}\n");
 				$userBuiltFlow->{_check_buttons_settings_aref} 
										=  $param_flow->get_check_buttons_settings();

  				 			 # print("4. pink_flow delete_from_flow_button, 
				...
				$whereami						->set4flow_listbox($flow_color);
				$here 							= $whereami->get4flow_listbox();
				 			 # print("pink_flow delete_from_flow_button, $here->{_is_flow_listbox_color_w}\n");
	    		...
	    		$param_widgets      		->set_location_in_gui($here);
 				...
 				$param_widgets				->set_check_buttons(
					  		 ...
					  		 # print("pink_flow, delete_from_flow_button, is listbox selected:$here->{_is_flow_listbox_color_w}\n");
 				$param_widgets				->redisplay_labels();
 				$param_widgets				->redisplay_values();
 					$param_widgets			->redisplay_check_buttons();
	#  			$param_widgets				->set_entry_change_status($false);	
 		...
 		print("pink_flow, delete_from_flow_button, flow color missing: \n");
 	}
}
...
sub drag {
  	my ($self) = @_;   
					# print("1. pink_flowdrag;just starting\n");
					# print("1. pink_flowdrag;listbox can not be empty\n");
					# print("1. pink_flowdrag;more than one item must exist\n");
  my $prog_name;
  if($userBuiltFlow->{_prog_name_sref}) {
	$prog_name					= ${$userBuiltFlow->{_prog_name_sref}};
	# print("1. pink_flowdrag,prog=$prog_name\n");
   }
 	...
 	if( $prog_name && $flow_widgets->is_drag_deleted($flow_listbox_pink_w) ) {
			...
			print("2.pink_flowdrag; prior index was deleted\n");
        my $this_index = $flow_widgets->get_drag_deleted_index($flow_listbox_pink_w);

			print("pink_flowdrag,deleting flow_listbox,idx=$this_index\n");
	...
	my $num_items = $flow_widgets->get_num_items($flow_listbox_pink_w);
  						# print("pink_flowdrag,num items prior to deletion  = $num_items\n");

  	if ( $num_items > 1 ) {  # num_items PRIOR to deletion
   	   $flow_widgets->drag_start($dnd_token_grey);
	    				# print("pink_flowdrag,start dnd_token_grey:$dnd_token_grey\n");
  	} else {
						# print("WARNING: pink_flowdrag,not allowed\n");
  	}						 
}
   ...
   if ($prog_name && $chosen_index_to_drop && $chosen_index_to_drop>=0  ) {   # same as destination_index
     ...
     $userBuiltFlow->{_destination_index} 	= $flow_widgets->destination_index;
							...
							# note the last program that was touched
    						 ...
    						 $userBuiltFlow->{_is_last_flow_index_touched} 	= $true;
							 	# print(" pink_flow drop, destination index = $userBuiltFlow->{_last_flow_index_touched}\n");
    ...
    #$flow_listbox_pink_w    ->selectionSet( $userBuiltFlow->{_destination_index},);
 ...
 sub flow_item_down_arrow_button{
	...
	if ($flow_color)  {
		...
		$prog_name						= ${$userBuiltFlow->{_prog_name_sref}};
			...
			# print("2. pink_flow,flow_item_down_arrow_button, flow_color: $userBuiltFlow->{_flow_color} \n"); 		
  			# print("3. pink_flow,flow_item_down_arrow_button, prog_name: $prog_name  \n");
		...
		# _set_flow_listbox_color_w($flow_color); # in "color"_flow namespace
	  	my $num_items 						= $flow_widgets->get_num_items($_flow_listbox_color_w );
	  				# my $num_items 						= $flow_widgets->get_num_items($flow_listbox_pink_w);	
	  		 		# print("4. pink_flow,flow_item_down_arrow_button, num_items: $num_items \n");
		...
		if ( $prog_name  && 
			...
			$userBuiltFlow->{_index2move} 			= $current_flow_listbox_index;
     		$userBuiltFlow->{_destination_index} 	= $destination_index;
     	 	...
     	 	# print("2. pink_flow,flow_item_down_arrow_button, destination_index: $destination_index \n");
     	 	# print("2. pink_flow,flow_item_down_arrow_button, current index: $current_flow_listbox_index\n");
     	 	
     	 	# modify flow listbox
     	 	#  _set_flow_listbox_color_w($flow_color); # in "color"_flow namespace
   			 # print("3. pink_flow,flow_item_down_arrow_button , _is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");
   			# print("3. pink_flow,flow_item_down_arrow_button,userBuiltFlow->listbox_widget: $userBuiltFlow->{_flow_listbox_color_w}\n");
   			
   			# get all the elements from inside the listbox 			
   			my @elements = $userBuiltFlow->{_flow_listbox_color_w}->get(0, 'end');
    		...
    		flow_select();
   	   		...
   	   		print("pink_flow, flow_item_down_arrow_button missing program or bad index\n");
		}
		 		
  	 } else {
  	 	print("pink_flow, flow_item_down_arrow_button missing color \n");
  	 }  		
...
sub flow_item_up_arrow_button {
	...
	if ($flow_color)  {
		...
		$prog_name						= ${$userBuiltFlow->{_prog_name_sref}};
			...
			# print("2. pink_flow,flow_item_up_arrow_button, flow_color: $userBuiltFlow->{_flow_color} \n"); 		
  			# print("3. pink_flow,flow_item_up_arrow_button, prog_name: $prog_name  \n");
		...
		# _set_flow_listbox_color_w($flow_color); # in "color"_flow namespace
 		my $_flow_listbox_color_w 			= _get_flow_listbox_color_w();  # user-built_flow in current use
	  	...
	  	my $num_items 						= $flow_widgets->get_num_items($_flow_listbox_color_w );
	  				# my $num_items 						= $flow_widgets->get_num_items($flow_listbox_pink_w);	
	  		 		# print("4. pink_flow,flow_item_up_arrow_button, num_items: $num_items \n");
		...
		if ( $prog_name  && 
    		...
    		$userBuiltFlow->{_is_last_flow_index_touched} 	= $true;
         	...
         	# modify flow listbox
     	 	#  _set_flow_listbox_color_w($flow_color); # in "color"_flow namespace
   			# print("3. pink_flow,flow_item_up_arrow_button , _is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");
   			# print("3. pink_flow,flow_item_up_arrow_button,userBuiltFlow->listbox_widget: $userBuiltFlow->{_flow_listbox_color_w}\n");
    		...
    		flow_select();
   	   		...
   	   		# print("pink_flow, flow_item_up_arrow_button missing program or bad index\n");
		}
		 		
  	 } else {
  	 	print("pink_flow, flow_item_up_arrow_button missing color \n");
  	 }  		
...
sub flow_select {
	...
	use messages::message_director;
	use decisions;  
				# print("1. pink_flow, flow_select,_is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");
				# print("1. pink_flow, flow_select,_is_flow_listbox_grey_w $userBuiltFlow->{_is_flow_listbox_grey_w}\n");
					# print("1. pink_flow, flow_select _values_aref[1] @{$userBuiltFlow->{_values_aref}}[1]\n"); 
				
	my $userBuiltFlow_messages 	= message_director->new();
	my $decisions				= decisions->new();
	
 			# print("2. pink_flow,flow_select,_flowNsuperflow_name_w : $userBuiltFlow->{_flowNsuperflow_name_w} \n");
			# $userBuiltFlow->{_names_aref} 		= $param_flow->get_names_aref();
			# print("2. pink_flow flow_select,parameter names: @{$userBuiltFlow->{_names_aref}}[0]\n");	
			# $userBuiltFlow->{_flow_type} = $flow_type->{_user_built}; 
			# print("4. pink_flow, flow_select, array of widgets: _values_w_aref=  @{$userBuiltFlow->{_values_w_aref}}\n");
			# my $value = @{$userBuiltFlow->{_values_w_aref}}[3]->get;
			# print("5. pink_flow, flow_select, first value of first widget: _values_w_aref= $value \n");
			
			# my $size = scalar @{$userBuiltFlow->{_values_aref}};
			# print("5. pink_flow, flow_select,no. values is $size\n");
			
	my $message          		= $userBuiltFlow_messages->null_button(0);
 	$message_w   				->delete("1.0",'end');
 	$message_w   				->insert('end', $message);
 	
			# print("6. pink_flow,, flow_select,flow color: $userBuiltFlow->{_flow_color} = flow_color $flow_color \n");
			
  	$conditions_gui				-> set_gui_widgets($userBuiltFlow);
 	$conditions_gui				-> set_hash_ref($userBuiltFlow);
	$conditions_gui				-> set4start_of_flow_select($flow_color);
	$userBuiltFlow				= $conditions_gui->get_hash_ref();
				# print("2. pink_flow, flow_select,_is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");
				# print("2. pink_flow, flow_select,_is_flow_listbox_grey_w $userBuiltFlow->{_is_flow_listbox_grey_w}\n");	
			# my $value = @{$userBuiltFlow->{_values_w_aref}}[1]->get;
			# print("7. pink_flow, flow_select, first value of first widget: _values_w_aref= $value \n");
	
	# update the flow color as per add2flow_select
	# _set_flow_listbox_color_w($flow_color); 	 # in "color"_flow namespace
	my $_flow_listbox_color_w  	= _get_flow_listbox_color_w();
	
				# print("3. pink_flow, flow_select,_is_flow_listbox_pink_w $userBuiltFlow->{_is_flow_listbox_pink_w}\n");
				# print("3. pink_flow, flow_select,_is_flow_listbox_grey_w $userBuiltFlow->{_is_flow_listbox_grey_w}\n");				
	# TODO: careful, color is re-assigned from conditions_gui,few lines up ... necessary?
	
	# independently set conditions to make pink box available
 	my $flow_color				= $userBuiltFlow ->{_flow_color}; 
 	
 				# print("9 pink_flow, flow_select,_last_flow_listbox_touched_w: $userBuiltFlow->{_last_flow_listbox_touched_w} \n");
 	 			# print("10. pink_flow,flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
 	 						
    $userBuiltFlow->{_prog_name_sref} 		= $flow_widgets->get_current_program(\$_flow_listbox_color_w );
    
    			# print("3 pink_flow,flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
	...
	my $pre_req_ok 	  						= $decisions->get4flow_select();
					...
					# print ("pink_flow, flow_select, pre_req_ok: $pre_req_ok\n");
				 	# print("12 pink_flow,flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
	...
	if ($pre_req_ok) {
		...
		$userBuiltFlow->{_prog_name_sref} 	= $flow_widgets->get_current_program(\$_flow_listbox_color_w );
 				 			...
 				 			# print ("8. pink_flow, flow_select, flow_color: $flow_color\n");
 				 			# print("13 pink_flow,flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
 				 					
			# Is a program deleted through a previous dragNdrop?
  			if( $flow_widgets->is_drag_deleted($_flow_listbox_color_w ) ) {

			  				 # print("\n\npink_flowflow_select,something was deleted in previous dragNdrop\n");
			  				 
        		my $this_index 		= $flow_widgets->get_drag_deleted_index($_flow_listbox_color_w );
        		
							 # print("pink_flowflow_select,deleting flow_listbox,idx=$thi# s_index\n");
     						 # print("index (old) $this_index was just removed from widget\n");
				...
				$flow_widgets->set_vigil_on_delete();
						...
						# print("3. pink_flow, flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
		...
		_check4flow_changes();
			...
			# my $value = @{$userBuiltFlow->{_values_w_aref}}[1]->get;
			# print("5. pink_flow, flow_select: _values_aref[1]= $value \n");  
		...
		# Update the flow item index to the program that is currently being used, instead of last-used program 
   		my $index 							= $flow_widgets->get_flow_selection($_flow_listbox_color_w );
						...
						# print("pink_flow, flow_select,_flow_listbox_color_w: $userBuiltFlow->{_flow_listbox_color_w} \n");
  						# print("pink_flow, flow_select, current index is $index\n");
  						# print("pink_flow, flow_select, last_flow_index_touched:$userBuiltFlow->{_last_flow_index_touched}\n");
						# print("pink_flow flow_select: _last_parameter_index_touched $userBuiltFlow->{_last_parameter_index_touched}\n");
 		...
 		$userBuiltFlow->{_names_aref} 		= $param_flow->get_names_aref();
  							...
  							# print("2. pink_flow flow_select,parameter names[1]: @{$userBuiltFlow->{_names_aref}}[1]\n");
  							# print("2. pink_flow flow_select,parameter values[1]:@{$userBuiltFlow->{_values_aref}}[1]\n");
 		$userBuiltFlow->{_values_aref} 		=	$param_flow->get_values_aref();
 		
  				 			  # print("3. pink_flow flow_select,parameter values:@{$userBuiltFlow->{_values_aref}}[1]\n");
  				 			 
 		$userBuiltFlow->{_check_buttons_settings_aref} 
									=  $param_flow->get_check_buttons_settings();

  				 			 # print("4. pink_flow flow_select, check_buttons_settings no changes, @{$userBuiltFlow->{_check_buttons_settings_aref}}\n");
  				 			 # print("4. pink_flow flow_select,index: $index \n");
 		...
 		$param_widgets				 			->set_current_program($userBuiltFlow->{_prog_name_sref});
 				 				...
 				 				# print("5. pink_flow, flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
				 			  	# print("pink_flow, flow_select, $userBuiltFlow->{_is_flow_listbox_color_w}\n");
				 			  	# print("pink_flow, flow_select, color:$flow_color\n");
				 			  	
		$whereami				->set4flow_listbox($flow_color);
		$here 					= $whereami->get4flow_listbox();
		
				 			  # print("5. pink_flow flow_select,here->{_is_flow_listbox_color_w: $here->{_is_flow_listbox_color_w}\n");
				 			  # print("pink_flow, flow_select, _is_flow_listbox_color_w, $here->{_is_flow_listbox_color_w}\n");
		 				 	  # print("6. pink_flow, flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");	
		 				 	  # print("7. pink_flow, flow_select,_param_flow_first_idx, $userBuiltFlow->{_param_flow_first_idx}\n");	
		  				 	  # print("8. pink_flow, flow_select,_param_flow_length, $userBuiltFlow->{_param_flow_length}\n");	
		...
		$param_widgets				->set_labels_w_aref($userBuiltFlow->{_labels_w_aref} );
 		...
 		$param_widgets				->set_check_buttons($userBuiltFlow->{_check_buttons_settings_aref});
					  		 ...
					  		 # print("6. pink_flow flow_select, is listbox selected:$here->{_is_flow_listbox_color_w}\n");
		$whereami					->set4flow_listbox($flow_color);
		$here 						= $whereami->get4flow_listbox();
							# print("6. pink_flow, flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");
    	$param_widgets      		->set_location_in_gui($here);
		...
		my @Entry_widget			= @{$param_widgets->get_values_w_aref()};
							# print("pink_flow, flow_select,Entry_widgets@Entry_widget\n");
		$Entry_widget[0]			->focus;  # always put focus on first entry widget
		...
		# Here is where you rebind the different buttons depending on the
 		...
 		$binding					->set();
				# print("7. pink_flow, flow_select, _values_w_aref $userBuiltFlow->{_values_w_aref}\n");

  		$conditions_gui				-> set_gui_widgets($userBuiltFlow);
 		$conditions_gui				-> set_hash_ref($userBuiltFlow);
    	$conditions_gui				-> set4end_of_flow_select($flow_color);
    	$conditions_gui				-> set_flow_index_last_touched($index);
   		  		 # print("14 pink_flow,flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");	
    	$userBuiltFlow 				= $conditions_gui->get_hash_ref(); # now pink_flow = 0; flow_type=user_built
    			# print("15. pink_flow,flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
    			# print("6. pink_flow,flow_select,flow_color: $userBuiltFlow->{_flow_color} \n");
    		
    		# Here is where you update th entry button value that displays the currently active 
			# flow or superflow name, by using the currently selected program name from the flow list
			# e.g. data_in, suximage, suxgraph etc.

				# print("8. pink_flow,flow_select,_flowNsuperflow_name_w : $userBuiltFlow->{_flowNsuperflow_name_w} \n");
				# print("16. pink_flow,flow_select,_prog_name_sref: ${$userBuiltFlow->{_prog_name_sref}} \n");
...
=cut
 	...
 	sub get_flow_color {
 		...
 		if( $userBuiltFlow->{_flow_color}) {
 			...
 			print("pink_flow, missing flow color\n");
 		}
...
=cut
 	...
 	sub get_flow_type{
 		...
 		if( $userBuiltFlow->{_flow_type}) {
 			...
 			print("pink_flow, missing flow type\n");
 		}
...
sub increase_vigil_on_delete_counter {
	...
	# print("pink_flowincrease_vigil_on_delete_counter\n");
	return();
}
...
sub help {
	...
	if ($pre_req_ok) {
	    ...
	    # print("pink_flow, help\n");
		$help->set_name($userBuiltFlow->{_prog_name_sref});
		$help->tkpod();
		
	} else {
		
		# print("1. pink_flow, can not provide help\n");
	}
...
=head2 sub save_button
	...
	topic: only 'Save'
  	...
  	run from L_SU.pm
   	...
   	my	$m          	= "pink_flow, _save_button, Test,set_specs,message,$message_w\n";
 	$message_w->delete("1.0",'end');
 	$message_w->insert('end', $m);
...
=cut
 ...
 sub save_button {
 	my ($self, $topic) = @_;
 		# print("pink_flow,save_button, topic: $topic\n");
 	if ($topic eq 'Save') {  # double-check
		...
		# $conditions_gui				-> set_gui_widgets($userBuiltFlow);  # uses 29/  113 in
 		# $conditions_gui				-> set_hash_ref($userBuiltFlow);     # uses 70/  113 in
		# $conditions_gui				-> set4start_of_SaveAs_button();	 # sets 2

  			# print("1. pink_flow, _save_button, B4 stored number of prgrams: $num_items\n");
  	 	$userBuiltFlow->{_names_aref} 	= $param_flow->get_names_aref();
  	 	
			# print("2. pink_flow ,save_button flow_name_out $userBuiltFlow->{_flow_name_out}\n");
			# my $num_items 			= $param_flow->get_num_items();
			# print("1. pink_flow, _save_button, B4 stored number of prgrams: $num_items\n");
		...
		$userBuiltFlow->{_prog_names_aref} 		= $param_flow->get_flow_prog_names_aref();
 		...
 		$files_LSU	->set_prog_param_labels_aref2($userBuiltFlow);	# uses 1 / 113 in
 		$files_LSU	->set_prog_param_values_aref2($userBuiltFlow);	# uses 1 / 113 in
 		$files_LSU	->set_prog_names_aref($userBuiltFlow);			# uses 1 / 113 in
 		$files_LSU	->set_items_versions_aref($userBuiltFlow);		# uses 1 / 113 in
 		$files_LSU	->set_data();
 		$files_LSU	->set_message($userBuiltFlow);  				# uses 1 / 113 in
 	...
 	sub set_hash_ref {
		...
		$userBuiltFlow->{_message_w}					= $hash_ref->{_message_w}; 
 		...
 		$userBuiltFlow->{_values_w_aref} 				= $hash_ref->{_values_w_aref};
 		 ...
 		 # print("pink_flowset_hash_ref,delete_from_flow_button: $delete_from_flow_button\n");
 		 # print("pink_flowset_hash_ref,parameter_values_frame: $userBuiltFlow->{_parameter_values_frame}\n");
 		 # print("1. pink_flowset_hash_ref,_message_w: $userBuiltFlow->{_message_w}\n");
 		 # print("pink_flowset_hash_ref,parameter_values_frame: $parameter_values_frame\n"); 	
 		 # print("pink_flowset_hash_ref,add2flow_button_pink,$add2flow_button_pink	\n");
 		 # print("pink_flow,set_hash_ref,userBuiltFlow->{_flow_color}: $userBuiltFlow->{_flow_color}	\n");
 		 # print("pink_flowset_hash_ref,delete_from_flow_button: $delete_from_flow_button\n");
 		 # print("pink_flow,set_hash_ref,flow_color: $flow_color\n");
 		 # print("pink_flow,set_hash_ref,_flowNsuperflow_name_w:$userBuiltFlow->{_flowNsuperflow_name_w}\n");

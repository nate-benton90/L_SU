...
=cut
 ...
 sub get4add2flow{
    ...
    $here->{_is_add2flow}     	= $whereami->{_is_add2flow};
    					 # print("1. whereami,get4flow_listbox, $here->{$_is_flow_listbox_color_w_text}\n");
   return($here);
...
=cut
 ...
 sub get4flow_listbox {
	...
	my $color 									= _get_flow_color();
	    	# print("1. whereami,get4flow_listbox, color: $color \n");
	    	
	if ($color) {
		my $_is_flow_listbox_color_w_text	 		= '_is_flow_listbox_'.$color.'_w';
   		$here->{$_is_flow_listbox_color_w_text}  	= $whereami->{$_is_flow_listbox_color_w_text};
...
=cut
 ...
 sub set4flow_listbox{
	...
	if ($color) {
    	...
    	#print("1. whereami,set4flow_listbox, whereami->{_is_flow_listbox_color_w_text}: $out\n");

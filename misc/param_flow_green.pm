...
=cut
 ...
 sub get_values_aref {
 	my ($self) 	= @_ ;
 		...
 		# print("param_flow, get_values :_values_aref2:$param_flow->{_values_aref2} \n");
...
#     
#  	for (my $i=0; $i<=$index;$i++) {
#     	print("param_flow_green,stack_names_aref2, an accumulating array of arrays: @{$param_flow->{_names_aref2}} item $i\n");
#  	} 
...
sub view_data {
    ...
    $num_progs[5] = scalar  ( @{$param_flow->{_prog_names_aref}});
	 ...
	 print("\nparam_flow,_prog_names @{$param_flow->{_prog_names_aref}}\n");
   	 ...
   	 # print("param_flow,view_data, param_flow_green_ has hash=$param_flow\n ");

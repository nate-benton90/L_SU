...
sub nobugreport {
	...
	$Dinver->{_note}	= $Dinver->{_note}.' -nobugreport '.$Dinver->{_nobugreport};
	$Dinver->{_Step}	= $Dinver->{_Step}.' -nobugreport '.$Dinver->{_nobugreport};
}
...
sub plug {
	...
	$Dinver->{_note}	= $Dinver->{_note}.' -i '.$Dinver->{_plug}.' -optimization ';
	$Dinver->{_Step}	= $Dinver->{_Step}.' -i '.$Dinver->{_plug}.' -optimization ';
}

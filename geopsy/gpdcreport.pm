...
sub maxmod {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -n '.$Gpdcreport->{_maxmod};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -n '.$Gpdcreport->{_maxmod};
}
...
sub maxmis {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -m '.$Gpdcreport->{_maxmis};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -m '.$Gpdcreport->{_maxmis};
}
...
sub best {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -best '.$Gpdcreport->{_best};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -best '.$Gpdcreport->{_best};
}
...
sub index {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -index '.$Gpdcreport->{_index};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -index '.$Gpdcreport->{_index};
}
...
sub pm {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -pm '.$Gpdcreport->{_pm};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -pm '.$Gpdcreport->{_pm};
}
...
sub gm {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -gm '.$Gpdcreport->{_gm};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -gm '.$Gpdcreport->{_gm};
}
...
sub vp {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -vp '.$Gpdcreport->{_vp};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -vp '.$Gpdcreport->{_vp};
}
...
sub vs {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -vs '.$Gpdcreport->{_vs};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -vs '.$Gpdcreport->{_vs};
}
...
sub pR {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -pR '.$Gpdcreport->{_pR};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -pR '.$Gpdcreport->{_pR};
}
...
sub pL {
	...
	$Gpdcreport->{_note}	= $Gpdcreport->{_note}.' -pL '.$Gpdcreport->{_pL};
	$Gpdcreport->{_Step}	= $Gpdcreport->{_Step}.' -pL '.$Gpdcreport->{_pL};
}

...
sub original {
	...
	$Gpprofile->{_note}	= $Gpprofile->{_note}.' -original '.$Gpprofile->{_original};
	$Gpprofile->{_Step}	= $Gpprofile->{_Step}.' -original '.$Gpprofile->{_original};
}
####
=pod
...
sub resample {
	...
	$Gpprofile->{_note}	= $Gpprofile->{_note}.' -resample '.$Gpprofile->{_resample};
	$Gpprofile->{_Step}	= $Gpprofile->{_Step}.' -resample '.$Gpprofile->{_resample};
}
...
sub samples {
	...
	$Gpprofile->{_note}	= $Gpprofile->{_note}.' -n '.$Gpprofile->{_samples};
	$Gpprofile->{_Step}	= $Gpprofile->{_Step}.' -n '.$Gpprofile->{_samples};
}
...
sub avgAt {
	...
	$Gpprofile->{_note}	= $Gpprofile->{_note}.' -avg-at '.$Gpprofile->{_avgAt};
	$Gpprofile->{_Step}	= $Gpprofile->{_Step}.' -avg-at '.$Gpprofile->{_avgAt};
}

...
sub mean {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -mean '.$Gphistogram->{_mean};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -mean '.$Gphistogram->{_mean};
}
...
sub median {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -median '.$Gphistogram->{_median};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -median '.$Gphistogram->{_median};
}
...
sub grid {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -grid '.$Gphistogram->{_grid};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -grid '.$Gphistogram->{_grid};
}
...
sub xsample {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -x-sampling '.$Gphistogram->{_xsample};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -x-sampling '.$Gphistogram->{_xsample};
}
...
sub xmin {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -x-min '.$Gphistogram->{_xmin};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -x-min '.$Gphistogram->{_xmin};
}
...
sub xmax {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -x-max '.$Gphistogram->{_xmax};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -x-max '.$Gphistogram->{_xmax};
}
...
sub xcount {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -x-count '.$Gphistogram->{_xcount};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -x-count '.$Gphistogram->{_xcount};
}
...
sub ysample {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -y-sampling '.$Gphistogram->{_ysample};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -y-sampling '.$Gphistogram->{_ysample};
}
...
sub ymin {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -y-min '.$Gphistogram->{_ymin};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -y-min '.$Gphistogram->{_ymin};
}
...
sub ymax {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -y-max '.$Gphistogram->{_ymax};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -y-max '.$Gphistogram->{_ymax};
}
...
sub ycount {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' -y-count '.$Gphistogram->{_ycount};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' -y-count '.$Gphistogram->{_ycount};
}
...
sub file {
	...
	$Gphistogram->{_note}	= $Gphistogram->{_note}.' '.$Gphistogram->{_file};
	$Gphistogram->{_Step}	= $Gphistogram->{_Step}.' '.$Gphistogram->{_file};
}

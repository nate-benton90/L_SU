...
sub profile {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -profile '.$Gpviewdcreport->{_profile};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -profile '.$Gpviewdcreport->{_profile};
}
...
sub dispersion {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -dispersion '.$Gpviewdcreport->{_dispersion};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -dispersion '.$Gpviewdcreport->{_dispersion};
}
...
sub maxmis {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -m '.$Gpviewdcreport->{_maxmis};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -m '.$Gpviewdcreport->{_maxmis};
}
...
sub export {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -export '.$Gpviewdcreport->{_export};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -export '.$Gpviewdcreport->{_export};
}
...
sub format {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -format '.$Gpviewdcreport->{_format};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -format '.$Gpviewdcreport->{_format};
}
...
sub nprofile {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -n '.$Gpviewdcreport->{_nprofile};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -n '.$Gpviewdcreport->{_nprofile};
}
...
sub nmodes {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -n '.$Gpviewdcreport->{_nmodes};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -n '.$Gpviewdcreport->{_nmodes};
}
...
sub slowness {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -s '.$Gpviewdcreport->{_slowness};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -s '.$Gpviewdcreport->{_slowness};
}
...
sub polarisation {
	...
	$Gpviewdcreport->{_polarisation}	= $polarisation if defined($polarisation);
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -p '.$Gpviewdcreport->{_polarisation};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -p '.$Gpviewdcreport->{_polarisation};
}
...
sub target {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -target '.$Gpviewdcreport->{_target};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -target '.$Gpviewdcreport->{_target};
}
...
sub dpi {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' -dpi '.$Gpviewdcreport->{_dpi};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' -dpi '.$Gpviewdcreport->{_dpi};
}
...
sub file {
	...
	$Gpviewdcreport->{_note}	= $Gpviewdcreport->{_note}.' '.$Gpviewdcreport->{_file};
	$Gpviewdcreport->{_Step}	= $Gpviewdcreport->{_Step}.' '.$Gpviewdcreport->{_file};
}
